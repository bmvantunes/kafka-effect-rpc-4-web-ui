 ...
 * @category tags
 */
export class Reactivity extends /*#__PURE__*/ServiceMap.Service()("effect/reactivity/Reactivity") {}
/**
 * @since 4.0.0
...
export const make = /*#__PURE__*/Effect.sync(() => {
  ...
  const invalidate = keys => Effect.servicesWith(services => {
...
class PendingInvalidation extends /*#__PURE__*/ServiceMap.Service()("effect/reactivity/Reactivity/PendingInvalidation") {}
/**
 * @since 4.0.0
 * @category accessors
 */
