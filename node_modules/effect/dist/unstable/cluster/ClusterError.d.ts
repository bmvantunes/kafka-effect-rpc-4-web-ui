...
declare const EntityNotAssignedToRunner_base: Schema.ErrorClass<EntityNotAssignedToRunner, Schema.Struct<{
...
declare const MalformedMessage_base: Schema.ErrorClass<MalformedMessage, Schema.Struct<{
...
declare const PersistenceError_base: Schema.ErrorClass<PersistenceError, Schema.Struct<{
...
declare const RunnerNotRegistered_base: Schema.ErrorClass<RunnerNotRegistered, Schema.Struct<{
...
declare const RunnerUnavailable_base: Schema.ErrorClass<RunnerUnavailable, Schema.Struct<{
...
declare const MailboxFull_base: Schema.ErrorClass<MailboxFull, Schema.Struct<{
...
declare const AlreadyProcessingMessage_base: Schema.ErrorClass<AlreadyProcessingMessage, Schema.Struct<{
