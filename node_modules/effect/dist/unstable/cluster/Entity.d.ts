...
declare const CurrentAddress_base: ServiceMap.ServiceClass<CurrentAddress, "effect/cluster/Entity/EntityAddress", EntityAddress>;
/**
...
declare const CurrentRunnerAddress_base: ServiceMap.ServiceClass<CurrentRunnerAddress, "effect/cluster/Entity/RunnerAddress", RunnerAddress>;
/**
...
export declare namespace Replier {
     ...
     * @category Replier
     */
    type Success<R extends Rpc.Any> = Rpc.Success<R> extends Stream.Stream<infer _A, infer _E, infer _R> ? Stream.Stream<_A, _E | Rpc.Error<R>, _R> | Queue.Dequeue<_A, _E | Rpc.Error<R>> : Rpc.Success<R>;
}
/**
 * @since 4.0.0
 * @category Request
...
declare const KeepAliveLatch_base: ServiceMap.ServiceClass<KeepAliveLatch, "effect/cluster/Entity/KeepAliveLatch", Latch.Latch>;
/**
 * @since 4.0.0
 * @category Keep alive
 */
