 ...
 * @category context
 */
export class CurrentAddress extends /*#__PURE__*/ServiceMap.Service()("effect/cluster/Entity/EntityAddress") {}
/**
 ...
 * @category context
 */
export class CurrentRunnerAddress extends /*#__PURE__*/ServiceMap.Service()("effect/cluster/Entity/RunnerAddress") {}
/**
 * @since 4.0.0
 * @category Request
 */
...
const shardingTag = /*#__PURE__*/ServiceMap.Service("effect/cluster/Sharding");
/**
 * @since 4.0.0
 * @category Testing
 */
export const makeTestClient = /*#__PURE__*/Effect.fnUntraced(function* (entity, layer) {
  ...
  const sharding = shardingTag.of({
    ...{},
    registerEntity: (entity, handlers, options) => Effect.servicesWith(services => {
      entityMap.set(entity.type, {
        services: services,
        concurrency: options?.concurrency ?? 1,
        build: entity.protocol.toHandlers(handlers).pipe(Effect.provideServices(services.pipe(ServiceMap.add(CurrentRunnerAddress, runnerAddress), ServiceMap.omit(Scope))))
      });
      return Effect.void;
    })
  });
 ...
 * @category Keep alive
 */
export class KeepAliveLatch extends /*#__PURE__*/ServiceMap.Service()("effect/cluster/Entity/KeepAliveLatch") {}
