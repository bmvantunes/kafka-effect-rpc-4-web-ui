 ...
 * @category models
 */
export class ShardingConfig extends /*#__PURE__*/ServiceMap.Service()("effect/cluster/ShardingConfig") {}
const defaultRunnerAddress = /*#__PURE__*/RunnerAddress.makeUnsafe({
  host: "localhost",
  port: 34431
});
/**
...
export const config = /*#__PURE__*/Config.all({
  ...
  }).pipe(/*#__PURE__*/Config.map(options => RunnerAddress.makeUnsafe(options)), Config.option, /*#__PURE__*/Config.map(Option.getOrUndefined)),
