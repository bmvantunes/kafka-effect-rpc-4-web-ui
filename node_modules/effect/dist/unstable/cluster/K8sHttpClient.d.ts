...
declare const K8sHttpClient_base: ServiceMap.ServiceClass<K8sHttpClient, "effect/cluster/K8sHttpClient", HttpClient.HttpClient>;
/**
 * @since 4.0.0
 * @category Tags
 */
...
declare const PodStatus_base: Schema.ExtendableClass<PodStatus, Schema.Struct<{
...
declare const Pod_base: Schema.ExtendableClass<Pod, Schema.Struct<{
