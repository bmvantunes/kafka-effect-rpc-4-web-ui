...
declare const Runners_base: ServiceMap.ServiceClass<Runners, "effect/cluster/Runners", {
    /**
...
declare const RpcClientProtocol_base: ServiceMap.ServiceClass<RpcClientProtocol, "effect/cluster/Runners/RpcClientProtocol", (address: RunnerAddress) => Effect.Effect<RpcClient_.Protocol["Service"], never, Scope>>;
/**
 * @since 1.0.0
 * @category Client
 */
