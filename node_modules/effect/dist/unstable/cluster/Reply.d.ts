...
declare const ReplyWithContext_base: new <A extends Record<string, any> = {}>(args: import("../../Types.ts").MatchRecord<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }, void, { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => Readonly<A> & {
...
declare const Chunk_base: new <A extends Record<string, any> = {}>(args: import("../../Types.ts").MatchRecord<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }, void, { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => Readonly<A> & {
    readonly _tag: "Chunk";
} & import("../../Pipeable.ts").Pipeable;
/**
 * @since 4.0.0
...
declare const WithExit_base: new <A extends Record<string, any> = {}>(args: import("../../Types.ts").MatchRecord<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }, void, { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => Readonly<A> & {
    readonly _tag: "WithExit";
} & import("../../Pipeable.ts").Pipeable;
/**
 * @since 4.0.0
