...
declare const MessageStorage_base: ServiceMap.ServiceClass<MessageStorage, "effect/cluster/MessageStorage", {
    /**
...
export declare const SaveResult: {
    ...
    readonly Duplicate: <A>(args: {
        ...
        readonly lastReceivedReply: Reply.Reply<A extends Rpc.Any ? A : never> | undefined;
...
export type Encoded = {
     ...
     * Retrieves the request id for the specified primary key.
     */
    readonly requestIdForPrimaryKey: (primaryKey: string) => Effect.Effect<Snowflake.Snowflake | undefined, PersistenceError>;
    /**
     * Retrieves the replies for the specified requests.
     *
     * - Un-acknowledged chunk replies
...
declare const MemoryDriver_base: ServiceMap.ServiceClass<MemoryDriver, "effect/cluster/MessageStorage/MemoryDriver", {
    readonly storage: {
        /**
         * Save the provided message and its associated metadata.
         */
