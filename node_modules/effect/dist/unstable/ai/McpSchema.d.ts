...
declare const ClientCapabilities_base: Schema.ExtendableClass<ClientCapabilities, Schema.Struct<{
    /**
...
declare const ParseError_base: Schema.ErrorClass<ParseError, Schema.Struct<{
...
declare const InvalidRequest_base: Schema.ErrorClass<InvalidRequest, Schema.Struct<{
...
declare const MethodNotFound_base: Schema.ErrorClass<MethodNotFound, Schema.Struct<{
...
declare const InvalidParams_base: Schema.ErrorClass<InvalidParams, Schema.Struct<{
...
declare const InternalError_base: Schema.ErrorClass<InternalError, Schema.Struct<{
...
declare const Resource_base: Schema.ExtendableClass<Resource, Schema.Struct<{
    /**
...
declare const ResourceTemplate_base: Schema.ExtendableClass<ResourceTemplate, Schema.Struct<{
    /**
...
declare const Prompt_base: Schema.ExtendableClass<Prompt, Schema.Struct<{
    /**
...
declare const Tool_base: Schema.ExtendableClass<Tool, Schema.Struct<{
    /**
...
declare const ModelPreferences_base: Schema.ExtendableClass<ModelPreferences, Schema.Struct<{
    /**
...
declare const CreateMessageResult_base: Schema.ExtendableClass<CreateMessageResult, Schema.Struct<{
    /**
...
declare const Root_base: Schema.ExtendableClass<Root, Schema.Struct<{
    /**
...
declare const ElicitAcceptResult_base: Schema.ExtendableClass<ElicitAcceptResult, Schema.Struct<{
    /**
...
declare const ElicitDeclineResult_base: Schema.ExtendableClass<ElicitDeclineResult, Schema.Struct<{
    /**
     * The user action in response to the elicitation.
     * - "accept": User submitted the form/confirmed the action
     * - "decline": User explicitly declined the action
...
declare const ElicitationDeclined_base: Schema.ErrorClass<ElicitationDeclined, Schema.Struct<{
...
declare const McpServerClient_base: ServiceMap.ServiceClass<McpServerClient, "effect/ai/McpSchema/McpServerClient", {
...
declare const McpServerClientMiddleware_base: RpcMiddleware.ServiceClass<McpServerClientMiddleware, "effect/ai/McpSchema/McpServerClientMiddleware", McpServerClient, Schema.Never, never, never>;
/**
 * @since 4.0.0
 * @category middleware
 */
