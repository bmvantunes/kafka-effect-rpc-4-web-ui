...
export interface Tool<out Name extends string, out Config extends {
     ...
     */
    addDependency<Identifier, Service>(tag: ServiceMap.Key<Identifier, Service>): Tool<Name, Config, Identifier | Requirements>;
    /**
 ...
 */
export declare const make: <const Name extends string, Parameters extends Schema.Top = typeof Schema.Void, Success extends Schema.Top = typeof Schema.Void, Failure extends Schema.Top = typeof Schema.Never, Mode extends FailureMode | undefined = undefined, Dependencies extends Array<ServiceMap.Key<any, any> | ServiceMap.Key<never, any>> = []>(name: Name, options?: {
    /**
...
declare const Title_base: ServiceMap.ServiceClass<Title, "effect/ai/Tool/Title", string>;
/**
...
declare const Meta_base: ServiceMap.ServiceClass<Meta, "effect/ai/Tool/Meta", Record<string, unknown>>;
/**
 ...
 * @category annotations
 */
export declare const Readonly: ServiceMap.Reference<boolean>;
/**
 ...
 * @category annotations
 */
export declare const Destructive: ServiceMap.Reference<boolean>;
/**
 ...
 * @category annotations
 */
export declare const Idempotent: ServiceMap.Reference<boolean>;
/**
 ...
 * @category annotations
 */
export declare const OpenWorld: ServiceMap.Reference<boolean>;
/**
 ...
 * @category annotations
 */
export declare const Strict: ServiceMap.Reference<boolean | undefined>;
/**
