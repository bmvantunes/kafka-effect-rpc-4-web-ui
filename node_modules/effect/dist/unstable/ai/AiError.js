...
const providerMetadataWithDefaults = () => ProviderMetadata.pipe(Schema.withConstructorDefault(() => Option.some({})), Schema.withDecodingDefault(() => ({})));
...
export const reasonFromHttpStatus = params => {
  ...
  const common = {
    http,
    ...(Predicate.isNotUndefined(metadata) ? {
      metadata
    } : {})
  };
  switch (status) {
