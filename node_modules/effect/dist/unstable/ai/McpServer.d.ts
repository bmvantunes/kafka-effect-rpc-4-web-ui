...
import type { CallTool, Complete, GetPrompt, Param, PromptMessage, ReadResourceResult } from "./McpSchema.ts";
import * as Tool from "./Tool.ts";
import type * as Toolkit from "./Toolkit.ts";
declare const McpServer_base: ServiceMap.ServiceClass<McpServer, "effect/ai/McpServer", {
    ...
    readonly addResource: (resource: Resource, handle: Effect.Effect<typeof ReadResourceResult.Type, InternalError, McpServerClient>) => Effect.Effect<void>;
