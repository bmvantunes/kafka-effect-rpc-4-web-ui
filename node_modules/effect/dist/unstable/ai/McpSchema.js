 ...
 * @since 4.0.0
 */
export const optionalWithDefault = (schema, defaultValue) => Schema.optionalKey(schema).pipe(Schema.decode({
  decode: Getter.withDefault(defaultValue),
  encode: Getter.passthrough()
}), Schema.withConstructorDefault(() => Option.some(defaultValue())));
/**
 * @since 4.0.0
 */
...
export class CompleteResult extends /*#__PURE__*/Schema.Opaque()(/*#__PURE__*/Schema.Struct({
   ...
   * @since 4.0.0
   */
  static empty = /*#__PURE__*/CompleteResult.makeUnsafe({
    completion: {
      values: [],
      total: 0,
      hasMore: false
 ...
 * @category client
 */
export class McpServerClient extends /*#__PURE__*/ServiceMap.Service()("effect/ai/McpSchema/McpServerClient") {}
/**
 * @since 4.0.0
 * @category middleware
 */
