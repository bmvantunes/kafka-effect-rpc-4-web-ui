...
declare const NetworkError_base: Schema.ErrorClass<NetworkError, Schema.Struct<{
...
declare const RateLimitError_base: Schema.ErrorClass<RateLimitError, Schema.Struct<{
...
declare const QuotaExhaustedError_base: Schema.ErrorClass<QuotaExhaustedError, Schema.Struct<{
...
declare const AuthenticationError_base: Schema.ErrorClass<AuthenticationError, Schema.Struct<{
...
declare const ContentPolicyError_base: Schema.ErrorClass<ContentPolicyError, Schema.Struct<{
...
declare const InvalidRequestError_base: Schema.ErrorClass<InvalidRequestError, Schema.Struct<{
...
declare const InternalProviderError_base: Schema.ErrorClass<InternalProviderError, Schema.Struct<{
...
declare const InvalidOutputError_base: Schema.ErrorClass<InvalidOutputError, Schema.Struct<{
...
declare const StructuredOutputError_base: Schema.ErrorClass<StructuredOutputError, Schema.Struct<{
...
declare const UnsupportedSchemaError_base: Schema.ErrorClass<UnsupportedSchemaError, Schema.Struct<{
...
declare const UnknownError_base: Schema.ErrorClass<UnknownError, Schema.Struct<{
...
declare const ToolNotFoundError_base: Schema.ErrorClass<ToolNotFoundError, Schema.Struct<{
...
declare const ToolParameterValidationError_base: Schema.ErrorClass<ToolParameterValidationError, Schema.Struct<{
...
declare const InvalidToolResultError_base: Schema.ErrorClass<InvalidToolResultError, Schema.Struct<{
...
declare const ToolResultEncodingError_base: Schema.ErrorClass<ToolResultEncodingError, Schema.Struct<{
...
declare const ToolConfigurationError_base: Schema.ErrorClass<ToolConfigurationError, Schema.Struct<{
...
declare const ToolkitRequiredError_base: Schema.ErrorClass<ToolkitRequiredError, Schema.Struct<{
...
declare const InvalidUserInputError_base: Schema.ErrorClass<InvalidUserInputError, Schema.Struct<{
...
declare const AiError_base: Schema.ErrorClass<AiError, Schema.Struct<{
