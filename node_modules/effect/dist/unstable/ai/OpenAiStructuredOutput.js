    ...
    case "Arrays":
      {
        ...
        if (ast.elements.length > 0) {
          ...
          return AST.decodeTo(recurOpenAI(new AST.Objects(propertySignatures, [], annotations, filters)), ast, Transformation.transform({
            decode: o => {
              let t = [];
    ...
    case "Objects":
      {
        ...
        if (ast.indexSignatures.length === 0) {
          ...
          return AST.decodeTo(recurOpenAI(new AST.Arrays(false, [], [new AST.Arrays(false, [is.parameter, is.type], [])], annotations)), ast, Transformation.transform({
