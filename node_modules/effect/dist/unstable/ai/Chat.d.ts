...
declare const Chat_base: ServiceMap.ServiceClass<Chat, "effect/ai/Chat", Service>;
/**
...
declare const ChatNotFoundError_base: Schema.ErrorClass<ChatNotFoundError, Schema.Struct<{
...
declare const Persistence_base: ServiceMap.ServiceClass<Persistence, "effect/ai/Chat/Persisted", Persistence.Service>;
/**
