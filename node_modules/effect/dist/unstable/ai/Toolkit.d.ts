...
export interface Toolkit<in out Tools extends Record<string, Tool.Any>> extends Effect.Yieldable<Toolkit<Tools>, WithHandler<Tools>, never, Tool.HandlersFor<Tools>>, Inspectable, Pipeable {
     ...
     * in the toolkit.
     */
    toHandlers<Handlers extends HandlersFrom<Tools>, EX = never, RX = never>(build: Handlers | Effect.Effect<Handlers, EX, RX>): Effect.Effect<ServiceMap.ServiceMap<Tool.HandlersFor<Tools>>, EX, RX>;
    /**
