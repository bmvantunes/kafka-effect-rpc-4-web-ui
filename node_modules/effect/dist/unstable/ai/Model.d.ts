 ...
 * @category models
 */
export interface Model<in out Provider, in out Provides, in out Requires> extends Layer.Layer<Provides | ProviderName | ModelName, never, Requires>, Effect.Yieldable<Model<Provider, Provides, Requires>, Layer.Layer<Provides | ProviderName | ModelName>, never, Requires> {
...
declare const ProviderName_base: ServiceMap.ServiceClass<ProviderName, "effect/unstable/ai/Model/ProviderName", string>;
/**
...
declare const ModelName_base: ServiceMap.ServiceClass<ModelName, "effect/unstable/ai/Model/ModelName", string>;
/**
