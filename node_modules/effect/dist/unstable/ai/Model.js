 ...
 * @category services
 */
export class ProviderName extends /*#__PURE__*/ServiceMap.Service()("effect/unstable/ai/Model/ProviderName") {}
/**
 ...
 * @category services
 */
export class ModelName extends /*#__PURE__*/ServiceMap.Service()("effect/unstable/ai/Model/ModelName") {}
const Proto = {
  ...YieldableProto,
  ...
  asEffect() {
    return Effect.servicesWith(services => Effect.succeed(Layer.provide(this, Layer.succeedServices(services))));
  },
  toJSON() {
    return {
      _id: "effect/ai/Model",
...
layer) => Object.assign(Object.create(Proto), {
  provider
}, Layer.merge(layer, Layer.succeedServices(ProviderName.serviceMap(provider).pipe(ServiceMap.add(ModelName, modelName)))));
