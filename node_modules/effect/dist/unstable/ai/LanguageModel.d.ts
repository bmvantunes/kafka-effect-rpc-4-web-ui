...
declare const LanguageModel_base: ServiceMap.ServiceClass<LanguageModel, "effect/unstable/ai/LanguageModel", Service>;
/**
...
export interface Service {
     ...
     */
    readonly generateText: <Options extends NoExcessProperties<GenerateTextOptions<any>, Options>, Tools extends Record<string, Tool.Any> = {}>(options: Options & GenerateTextOptions<Tools>) => Effect.Effect<GenerateTextResponse<Tools>, ExtractError<Options>, ExtractServices<Options>>;
    /**
     ...
     */
    readonly streamText: <Options extends NoExcessProperties<GenerateTextOptions<any>, Options>, Tools extends Record<string, Tool.Any> = {}>(options: Options & GenerateTextOptions<Tools>) => Stream.Stream<Response.StreamPart<Tools>, ExtractError<Options>, ExtractServices<Options>>;
}
/**
 ...
 * @category services
 */
export declare const CurrentCodecTransformer: ServiceMap.Reference<CodecTransformer>;
/**
...
export interface GenerateTextOptions<Tools extends Record<string, Tool.Any>> {
     ...
     */
    readonly toolkit?: Toolkit.WithHandler<Tools> | Effect.Yieldable<Toolkit.Toolkit<Tools>, Toolkit.WithHandler<Tools>, never, any> | undefined;
    /**
...
} ? AiError.AiError : Options extends {
    readonly toolkit: Effect.Yieldable<Toolkit.Toolkit<infer _Tools>, Toolkit.WithHandler<infer _Tools>, infer _E, infer _R>;
    readonly disableToolCallResolution: true;
} ? AiError.AiError | _E : Options extends {
    readonly toolkit: Toolkit.WithHandler<infer _Tools>;
} ? AiError.AiError | Tool.HandlerError<_Tools[keyof _Tools]> : Options extends {
    readonly toolkit: Effect.Yieldable<Toolkit.Toolkit<infer _Tools>, Toolkit.WithHandler<infer _Tools>, infer _E, infer _R>;
} ? AiError.AiError | Tool.HandlerError<_Tools[keyof _Tools]> | _E : AiError.AiError;
/**
...
export type ExtractServices<Options> = Options extends {
    ...
    readonly toolkit: Toolkit.WithHandler<infer _Tools>;
} ? Tool.ResultEncodingServices<_Tools[keyof _Tools]> | Tool.ResultDecodingServices<_Tools[keyof _Tools]> : Options extends {
    readonly toolkit: Effect.Yieldable<Toolkit.Toolkit<infer _Tools>, Toolkit.WithHandler<infer _Tools>, infer _E, infer _R>;
} ? Tool.ResultEncodingServices<_Tools[keyof _Tools]> | Tool.ResultDecodingServices<_Tools[keyof _Tools]> | _R : never;
/**
