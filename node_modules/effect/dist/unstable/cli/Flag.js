 ...
 */
export const string = name => Param.string(Param.flagKind, name);
/**
 ...
 * @category constructors
 */
export const boolean = name => Param.boolean(Param.flagKind, name);
/**
 ...
 * @category constructors
 */
export const integer = name => Param.integer(Param.flagKind, name);
/**
 ...
 * @category constructors
 */
export const float = name => Param.float(Param.flagKind, name);
/**
 ...
 * @category constructors
 */
export const date = name => Param.date(Param.flagKind, name);
/**
 ...
 * @category constructors
 */
export const choiceWithValue = (name, choices) => Param.choiceWithValue(Param.flagKind, name, choices);
/**
 ...
 * @category constructors
 */
export const choice = (name, choices) => Param.choice(Param.flagKind, name, choices);
/**
 ...
 * @category constructors
 */
export const path = (name, options) => Param.path(Param.flagKind, name, options);
/**
 ...
 * @category constructors
 */
export const file = (name, options) => Param.file(Param.flagKind, name, options);
/**
 ...
 * @category constructors
 */
export const directory = (name, options) => Param.directory(Param.flagKind, name, options);
/**
 ...
 * @category constructors
 */
export const redacted = name => Param.redacted(Param.flagKind, name);
/**
 ...
 * @category constructors
 */
export const fileText = name => Param.fileText(Param.flagKind, name);
/**
 ...
 * @category constructors
 */
export const fileParse = (name, options) => Param.fileParse(Param.flagKind, name, options);
/**
 ...
 * @category constructors
 */
export const fileSchema = (name, schema, options) => Param.fileSchema(Param.flagKind, name, schema, options);
/**
 ...
 * @category constructors
 */
export const keyValuePair = name => Param.keyValuePair(Param.flagKind, name);
/**
 ...
 * @category constructors
 */
export const none = /*#__PURE__*/Param.none(Param.flagKind);
// -------------------------------------------------------------------------------------
// combinators
// -------------------------------------------------------------------------------------
/**
 ...
 * @category aliasing
 */
export const withAlias = /*#__PURE__*/dual(2, (self, alias) => Param.withAlias(self, alias));
/**
 ...
 */
export const optional = param => Param.optional(param);
/**
