...
type ExtractGlobalFlagContext<T extends ReadonlyArray<GlobalFlag.GlobalFlag<any>>> = T[number] extends infer F ? F extends GlobalFlag.Setting<infer Id, any> ? GlobalFlag.Setting.Identifier<Id> : never : never;
type ExtractSubcommand<T> = T extends Command<any, any, any, any, any> ? T : T extends Command.SubcommandGroup<infer Commands> ? Commands[number] : never;
type ExtractSubcommandErrors<T extends ReadonlyArray<Command.SubcommandEntry>> = Error<ExtractSubcommand<T[number]>>;
type ExtractSubcommandContext<T extends ReadonlyArray<Command.SubcommandEntry>> = ExtractSubcommand<T[number]> extends Command<any, any, any, any, infer R> ? R : never;
/**
...
export declare const annotate: {
     ...
     * @category combinators
     */
    <I, S>(service: ServiceMap.Key<I, S>, value: NoInfer<S>): <Name extends string, Input, E, R, ContextInput>(self: Command<Name, Input, ContextInput, E, R>) => Command<Name, Input, ContextInput, E, R>;
    /**
     * Adds a custom annotation to a command.
     *
     * @since 4.0.0
     * @category combinators
     */
    <Name extends string, Input, E, R, ContextInput, I, S>(self: Command<Name, Input, ContextInput, E, R>, service: ServiceMap.Key<I, S>, value: NoInfer<S>): Command<Name, Input, ContextInput, E, R>;
};
/**
...
export declare const annotateMerge: {
     ...
     * @category combinators
     */
    <I>(annotations: ServiceMap.ServiceMap<I>): <Name extends string, Input, E, R, ContextInput>(self: Command<Name, Input, ContextInput, E, R>) => Command<Name, Input, ContextInput, E, R>;
    /**
     * Merges a ServiceMap of annotations into a command.
     *
     * @since 4.0.0
     * @category combinators
     */
    <Name extends string, Input, E, R, ContextInput, I>(self: Command<Name, Input, ContextInput, E, R>, annotations: ServiceMap.ServiceMap<I>): Command<Name, Input, ContextInput, E, R>;
};
/**
...
export declare const provideSync: {
     ...
     * @category providing services
     */
    <I, S, Input>(service: ServiceMap.Key<I, S>, implementation: S | ((input: Input) => S)): <const Name extends string, E, R, ContextInput>(self: Command<Name, Input, ContextInput, E, R>) => Command<Name, Input, ContextInput, E, Exclude<R, I>>;
    /**
     * Provides the handler of a command with the implementation of a service that
     * optionally depends on the command-line input to be constructed.
     *
     ...
     * @category providing services
     */
    <const Name extends string, Input, E, R, ContextInput, I, S>(self: Command<Name, Input, ContextInput, E, R>, service: ServiceMap.Key<I, S>, implementation: S | ((input: Input) => S)): Command<Name, Input, ContextInput, E, Exclude<R, I>>;
};
/**
...
export declare const provideEffect: {
     ...
     * @category providing services
     */
    <I, S, Input, R2, E2>(service: ServiceMap.Key<I, S>, effect: Effect.Effect<S, E2, R2> | ((input: Input) => Effect.Effect<S, E2, R2>)): <const Name extends string, E, R, ContextInput>(self: Command<Name, Input, ContextInput, E, R>) => Command<Name, Input, ContextInput, E | E2, Exclude<R, I> | R2>;
    /**
     * Provides the handler of a command with the service produced by an effect
     * that optionally depends on the command-line input to be created.
     *
     ...
     * @category providing services
     */
    <const Name extends string, Input, E, R, ContextInput, I, S, R2, E2>(self: Command<Name, Input, ContextInput, E, R>, service: ServiceMap.Key<I, S>, effect: Effect.Effect<S, E2, R2> | ((input: Input) => Effect.Effect<S, E2, R2>)): Command<Name, Input, ContextInput, E | E2, Exclude<R, I> | R2>;
};
/**
