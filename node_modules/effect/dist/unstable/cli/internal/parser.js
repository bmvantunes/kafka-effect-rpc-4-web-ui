...
/* ========================================================================== */
/** @internal */
export const getCommandPath = parsedInput => parsedInput.subcommand ? [parsedInput.subcommand.name, ...getCommandPath(parsedInput.subcommand.parsedInput)] : [];
/** @internal */
 ...
 */
const consumeFlagValue = (cursor, token, spec) => {
