...
declare const UnrecognizedOption_base: Schema.ErrorClass<unknown, Schema.Struct<{
...
declare const DuplicateOption_base: Schema.ErrorClass<unknown, Schema.Struct<{
...
declare const MissingOption_base: Schema.ErrorClass<unknown, Schema.Struct<{
...
declare const MissingArgument_base: Schema.ErrorClass<unknown, Schema.Struct<{
...
declare const InvalidValue_base: Schema.ErrorClass<unknown, Schema.Struct<{
...
declare const UnknownSubcommand_base: Schema.ErrorClass<unknown, Schema.Struct<{
