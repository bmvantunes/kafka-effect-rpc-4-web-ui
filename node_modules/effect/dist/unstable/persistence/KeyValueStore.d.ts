...
declare const KeyValueStoreError_base: new <A extends Record<string, any> = {}>(args: import("../../Types.ts").MatchRecord<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }, void, { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("../../Cause.ts").YieldableError & {
 ...
 * @category tags
 */
export declare const KeyValueStore: ServiceMap.Service<KeyValueStore, KeyValueStore>;
/**
 * @since 4.0.0
