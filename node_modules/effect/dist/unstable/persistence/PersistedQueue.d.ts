...
declare const PersistedQueueFactory_base: ServiceMap.ServiceClass<PersistedQueueFactory, "effect/persistence/PersistedQueue/PersistedQueueFactory", {
...
declare const PersistedQueueError_base: Schema.ErrorClass<PersistedQueueError, Schema.Struct<{
...
declare const PersistedQueueStore_base: ServiceMap.ServiceClass<PersistedQueueStore, "effect/persistence/PersistedQueue/PersistedQueueStore", {
