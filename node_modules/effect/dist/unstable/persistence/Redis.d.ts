...
declare const Redis_base: ServiceMap.ServiceClass<Redis, "effect/persistence/Redis", {
...
declare const RedisError_base: Schema.ErrorClass<RedisError, Schema.Struct<{
