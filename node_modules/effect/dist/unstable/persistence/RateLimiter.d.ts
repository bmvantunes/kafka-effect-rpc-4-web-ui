 ...
 * @category Tags
 */
export declare const RateLimiter: ServiceMap.Service<RateLimiter, RateLimiter>;
/**
 * @since 4.0.0
...
declare const RateLimitExceeded_base: Schema.ErrorClass<RateLimitExceeded, Schema.Struct<{
...
declare const RateLimitStoreError_base: Schema.ErrorClass<RateLimitStoreError, Schema.Struct<{
...
declare const RateLimiterError_base: Schema.ErrorClass<RateLimiterError, Schema.Struct<{
...
declare const RateLimiterStore_base: ServiceMap.ServiceClass<RateLimiterStore, "effect/persistence/RateLimiter/RateLimiterStore", {
    /**
