 ...
 * @since 4.0.0
 */
export declare const SqlClient: ServiceMap.Service<SqlClient, SqlClient>;
/**
 * @category models
 * @since 4.0.0
 */
...
declare const TransactionConnection_base: ServiceMap.ServiceClass<TransactionConnection, "effect/sql/SqlClient/TransactionConnection", readonly [conn: Connection.Connection, depth: number]>;
/**
 * @since 4.0.0
 */
 ...
 * @since 4.0.0
 */
export declare const SafeIntegers: ServiceMap.Reference<boolean>;
export {};
