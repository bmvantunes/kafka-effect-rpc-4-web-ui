 ...
 * @category Services
 */
export class WorkflowEngine extends /*#__PURE__*/ServiceMap.Service()("effect/workflow/WorkflowEngine") {}
/**
 * @since 4.0.0
 * @category Services
 */
export class WorkflowInstance extends /*#__PURE__*/ServiceMap.Service()("effect/workflow/WorkflowEngine/WorkflowInstance") {
...
export const makeUnsafe = options => WorkflowEngine.of({
  register: Effect.fnUntraced(function* (workflow, execute) {
    ...
    yield* options.register(workflow, (payload, executionId) => Effect.suspend(() => execute(payload, executionId)).pipe(Effect.updateServices(input => ServiceMap.merge(services, input))));
  }),
  ...
  deferredResult: Effect.fnUntraced(function* (deferred) {
    ...
    return yield* Effect.orDie(Schema.decodeEffect(deferred.exitSchema)(toJsonExit(exit)));
