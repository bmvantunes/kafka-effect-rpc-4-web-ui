...
const EngineTag = /*#__PURE__*/ServiceMap.Service("effect/workflow/WorkflowEngine");
const InstanceTag = /*#__PURE__*/ServiceMap.Service("effect/workflow/WorkflowEngine/WorkflowInstance");
/**
 * @since 4.0.0
...
export const make = options => {
  ...
  const self = {
    ...
    executionId: payload => Effect.flatMap(Effect.sync(() => self.payloadSchema.makeUnsafe(payload)), makeExecutionId),
    withCompensation
  };
  return self;
};
 ...
 * @category Result
 */
export const intoResult = effect => Effect.servicesWith(services => {
 ...
 * @category Result
 */
export const wrapActivityResult = (effect, isSuspend) => Effect.servicesWith(services => {
  const instance = ServiceMap.get(services, InstanceTag);
 ...
 */
export const CaptureDefects = /*#__PURE__*/ServiceMap.Reference("effect/workflow/Workflow/CaptureDefects", {
 ...
 * @category Annotations
 */
export const SuspendOnFailure = /*#__PURE__*/ServiceMap.Reference("effect/workflow/Workflow/SuspendOnFailure", {
