...
declare const WorkflowEngine_base: ServiceMap.ServiceClass<WorkflowEngine, "effect/workflow/WorkflowEngine", {
    /**
     ...
     * Execute a registered workflow.
     */
    readonly poll: <Name extends string, Payload extends Workflow.AnyStructSchema, Success extends Schema.Top, Error extends Schema.Top>(workflow: Workflow.Workflow<Name, Payload, Success, Error>, executionId: string) => Effect.Effect<Workflow.Result<Success["Type"], Error["Type"]> | undefined, never, Success["DecodingServices"] | Error["DecodingServices"]>;
    /**
     ...
     */
    readonly deferredResult: <Success extends Schema.Top, Error extends Schema.Top>(deferred: DurableDeferred.DurableDeferred<Success, Error>) => Effect.Effect<Exit.Exit<Success["Type"], Error["Type"]> | undefined, never, WorkflowInstance>;
    /**
...
declare const WorkflowInstance_base: ServiceMap.ServiceClass<WorkflowInstance, "effect/workflow/WorkflowEngine/WorkflowInstance", {
    /**
