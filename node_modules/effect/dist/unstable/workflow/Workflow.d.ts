...
export interface Workflow<Name extends string, Payload extends AnyStructSchema, Success extends Schema.Top, Error extends Schema.Top> {
     ...
     */
    annotate<I, S>(key: ServiceMap.Key<I, S>, value: S): Workflow<Name, Payload, Success, Error>;
    /**
     * Merge multiple annotations into the workflow.
     */
    annotateMerge<I>(annotations: ServiceMap.ServiceMap<I>): Workflow<Name, Payload, Success, Error>;
    /**
     ...
     * Execute the workflow with the given payload.
     */
    readonly poll: (executionId: string) => Effect.Effect<Result<Success["Type"], Error["Type"]> | undefined, never, WorkflowEngine | Success["DecodingServices"] | Error["DecodingServices"]>;
    /**
...
declare const Complete_base: new <A_1 extends Record<string, any> = {}>(args: import("../../Types.ts").MatchRecord<{ readonly [P in keyof A_1 as P extends "_tag" ? never : P]: A_1[P]; }, void, { readonly [P in keyof A_1 as P extends "_tag" ? never : P]: A_1[P]; }>) => Readonly<A_1> & {
    readonly _tag: "Complete";
...
declare const Suspended_base: Schema.ExtendableClass<Suspended, Schema.Struct<{
 ...
 */
export declare const CaptureDefects: ServiceMap.Reference<boolean>;
/**
 ...
 * @category Annotations
 */
export declare const SuspendOnFailure: ServiceMap.Reference<boolean>;
export {};
