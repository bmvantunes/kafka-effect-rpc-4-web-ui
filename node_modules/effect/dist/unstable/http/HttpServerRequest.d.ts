 ...
 * @category context
 */
export declare const HttpServerRequest: ServiceMap.Service<HttpServerRequest, HttpServerRequest>;
declare const ParsedSearchParams_base: ServiceMap.ServiceClass<ParsedSearchParams, "effect/http/ParsedSearchParams", ReadonlyRecord<string, string | string[]>>;
/**
 * @since 4.0.0
