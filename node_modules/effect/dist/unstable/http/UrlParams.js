 ...
 * @category combinators
 */
export const getFirst = /*#__PURE__*/dual(2, (self, key) => Arr.findFirst(self.params, ([k]) => k === key).pipe(Option.map(([, value]) => value), Option.getOrUndefined));
/**
 * @since 4.0.0
 * @category combinators
 */
export const getLast = /*#__PURE__*/dual(2, (self, key) => Arr.findLast(self.params, ([k]) => k === key).pipe(Option.map(([, value]) => value), Option.getOrUndefined));
/**
 * @since 4.0.0
 * @category combinators
 */
...
export const schemaJsonField = field => UrlParamsSchema.pipe(Schema.decodeTo(Schema.UnknownFromJsonString, Transformation.transformOrFail({
  decode: params => UndefinedOr.match(getFirst(params, field), {
