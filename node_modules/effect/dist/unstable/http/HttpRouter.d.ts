 ...
 * @category HttpRouter
 */
export declare const HttpRouter: ServiceMap.Service<HttpRouter, HttpRouter>;
/**
 * @since 4.0.0
 * @category HttpRouter
 */
 ...
 */
export declare const RouterConfig: ServiceMap.Reference<Partial<FindMyWay.RouterConfig>>;
declare const RouteContext_base: ServiceMap.ServiceClass<RouteContext, "effect/http/HttpRouter/RouteContext", {
...
export declare const toWebHandler: <A, E, R extends HttpRouter | Request<"Requires", any> | Request<"GlobalRequires", any> | Request<"Error", any> | Request<"GlobalError", any>, HE, HR = Exclude<Request.Only<"Requires", R> | Request.Only<"GlobalRequires", R>, A>>(appLayer: Layer.Layer<A, E, R>, options?: {
    ...
    readonly handler: [HR] extends [never] ? ((request: globalThis.Request, context?: ServiceMap.ServiceMap<never> | undefined) => Promise<Response>) : ((request: globalThis.Request, context: ServiceMap.ServiceMap<HR>) => Promise<Response>);
