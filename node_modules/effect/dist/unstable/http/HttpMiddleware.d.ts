 ...
 * @category Tracer
 */
export declare const TracerDisabledWhen: ServiceMap.Reference<Predicate<HttpServerRequest>>;
/**
 * @since 4.0.0
 * @category Tracer
 */
 ...
 * @category Tracer
 */
export declare const SpanNameGenerator: ServiceMap.Reference<(request: HttpServerRequest) => string>;
/**
 * @since 4.0.0
 * @category Logger
 */
