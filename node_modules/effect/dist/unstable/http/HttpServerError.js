 ...
 */
export class ClientAbort extends /*#__PURE__*/ServiceMap.Service()("effect/http/HttpServerError/ClientAbort") {
  static annotation = /*#__PURE__*/this.serviceMap(true).pipe(/*#__PURE__*/ServiceMap.add(Cause.StackTrace, {
    name: "ClientAbort",
...
export const causeResponseStripped = cause => {
  ...
  return [response ?? internalServerError, failures.length > 0 ? Cause.fromReasons(failures) : undefined];
};
