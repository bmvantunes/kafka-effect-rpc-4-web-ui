...
declare const HttpServerError_base: new <A extends Record<string, any> = {}>(args: import("../../Types.ts").MatchRecord<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }, void, { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => Cause.YieldableError & {
...
declare const RequestParseError_base: new <A extends Record<string, any> = {}>(args: import("../../Types.ts").MatchRecord<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }, void, { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => Cause.YieldableError & {
...
declare const RouteNotFound_base: new <A extends Record<string, any> = {}>(args: import("../../Types.ts").MatchRecord<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }, void, { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => Cause.YieldableError & {
...
declare const InternalError_base: new <A extends Record<string, any> = {}>(args: import("../../Types.ts").MatchRecord<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }, void, { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => Cause.YieldableError & {
...
declare const ResponseError_base: new <A extends Record<string, any> = {}>(args: import("../../Types.ts").MatchRecord<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }, void, { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => Cause.YieldableError & {
...
declare const ServeError_base: new <A extends Record<string, any> = {}>(args: import("../../Types.ts").MatchRecord<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }, void, { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => Cause.YieldableError & {
...
declare const ClientAbort_base: ServiceMap.ServiceClass<ClientAbort, "effect/http/HttpServerError/ClientAbort", true>;
/**
 * @since 4.0.0
 * @category Annotations
 */
export declare class ClientAbort extends ClientAbort_base {
    static annotation: ServiceMap.ServiceMap<Cause.StackTrace | ClientAbort>;
}
/**
 * @since 4.0.0
 */
