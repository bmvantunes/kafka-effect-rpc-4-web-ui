 ...
 * @category tags
 */
export declare const HttpClient: ServiceMap.Service<HttpClient, HttpClient>;
/**
 * @since 4.0.0
 * @category accessors
 */
 ...
 * @category References
 */
export declare const TracerDisabledWhen: ServiceMap.Reference<Predicate.Predicate<HttpClientRequest.HttpClientRequest>>;
/**
 * @since 4.0.0
 * @category References
 */
export declare const TracerPropagationEnabled: ServiceMap.Reference<boolean>;
/**
 * @since 4.0.0
 * @category References
 */
export declare const SpanNameGenerator: ServiceMap.Reference<(request: HttpClientRequest.HttpClientRequest) => string>;
/**
 * @since 4.0.0
 */
