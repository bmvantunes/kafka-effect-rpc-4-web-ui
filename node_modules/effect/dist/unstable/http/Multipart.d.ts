...
declare const MultipartError_base: new <A extends Record<string, any> = {}>(args: import("../../Types.ts").MatchRecord<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }, void, { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => Cause.YieldableError & {
 ...
 * @category References
 */
export declare const MaxParts: ServiceMap.Reference<number | undefined>;
/**
 * @since 4.0.0
 * @category References
 */
export declare const MaxFieldSize: ServiceMap.Reference<FileSystem.SizeInput>;
/**
 * @since 4.0.0
 * @category References
 */
export declare const MaxFileSize: ServiceMap.Reference<FileSystem.SizeInput | undefined>;
/**
 * @since 4.0.0
 * @category References
 */
export declare const FieldMimeTypes: ServiceMap.Reference<readonly string[]>;
export {};
