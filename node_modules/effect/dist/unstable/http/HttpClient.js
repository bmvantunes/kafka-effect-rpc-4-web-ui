 ...
 * @category tags
 */
export const HttpClient = /*#__PURE__*/ServiceMap.Service("effect/HttpClient");
 ...
 * @category References
 */
export const TracerDisabledWhen = /*#__PURE__*/ServiceMap.Reference("effect/http/HttpClient/TracerDisabledWhen", {
 ...
 * @category References
 */
export const TracerPropagationEnabled = /*#__PURE__*/ServiceMap.Reference("effect/HttpClient/TracerPropagationEnabled", {
 ...
 * @category References
 */
export const SpanNameGenerator = /*#__PURE__*/ServiceMap.Reference("effect/http/HttpClient/SpanNameGenerator", {
  defaultValue: () => request => `http.client ${request.method}`
});
/**
 * @since 4.0.0
 */
export const layerMergedServices = effect => Layer.effect(HttpClient)(Effect.servicesWith(services => Effect.map(effect, client => transformResponse(client, Effect.updateServices(input => ServiceMap.merge(services, input))))));
// -----------------------------------------------------------------------------
// internal
// -----------------------------------------------------------------------------
