 ...
 * @category models
 */
export class HttpServer extends /*#__PURE__*/ServiceMap.Service()("effect/http/HttpServer") {}
/**
 * @since 4.0.0
 ...
 * @category accessors
 */
export const serve = /*#__PURE__*/dual(args => Effect.isEffect(args[0]), (effect, middleware) => Layer.effectDiscard(Effect.flatMap(HttpServer.asEffect(), server => server.serve(effect, middleware))));
/**
 * @since 4.0.0
 * @category accessors
 */
export const serveEffect = /*#__PURE__*/dual(args => Effect.isEffect(args[0]), (effect, middleware) => Effect.flatMap(HttpServer.asEffect(), server => server.serve(effect, middleware)));
/**
 * @since 4.0.0
 * @category address
 */
