 ...
 * @category overrideable
 */
export interface Overrideable<S extends Schema.Top & Schema.WithoutConstructorDefault> extends Schema.Bottom<(S["Type"] & Brand<"Override">) | undefined, S["Encoded"], S["DecodingServices"], S["EncodingServices"], S["ast"], Overrideable<S>, S["~type.make.in"], (S["Type"] & Brand<"Override">) | undefined, S["~type.parameters"], (S["Type"] & Brand<"Override">) | undefined, S["~type.mutability"], "optional", "with-default", S["~encoded.mutability"], S["~encoded.optionality"]> {
}
/**
 * @since 4.0.0
 * @category overrideable
