...
declare const Collector_base: ServiceMap.ServiceClass<Collector, "effect/workers/Transferable/Collector", {
 ...
 * @category schema
 */
export interface Transferable<S extends Schema.Top> extends Schema.decodeTo<Schema.toType<S["~rebuild.out"]>, S["~rebuild.out"]> {
}
/**
 * @since 1.0.0
 * @category schema
 ...
 * @category schema
 */
export declare const Uint8Array: Transferable<Schema.Uint8Array>;
export {};
