...
declare const WorkerPlatform_base: ServiceMap.ServiceClass<WorkerPlatform, "effect/workers/Worker/WorkerPlatform", {
 ...
 * @category tags
 */
export declare const Spawner: ServiceMap.Service<Spawner, SpawnerFn<unknown>>;
/**
 * @since 4.0.0
 * @category models
 */
