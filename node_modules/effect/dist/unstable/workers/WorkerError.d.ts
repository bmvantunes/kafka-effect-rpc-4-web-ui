...
declare const WorkerSpawnError_base: Schema.ErrorClass<WorkerSpawnError, Schema.Struct<{
...
declare const WorkerSendError_base: Schema.ErrorClass<WorkerSendError, Schema.Struct<{
...
declare const WorkerReceiveError_base: Schema.ErrorClass<WorkerReceiveError, Schema.Struct<{
...
declare const WorkerUnknownError_base: Schema.ErrorClass<WorkerUnknownError, Schema.Struct<{
...
declare const WorkerError_base: Schema.ErrorClass<WorkerError, Schema.Struct<{
