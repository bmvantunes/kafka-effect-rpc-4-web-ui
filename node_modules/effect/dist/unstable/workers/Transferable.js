 ...
 * @category models
 */
export class Collector extends /*#__PURE__*/ServiceMap.Service()("effect/workers/Transferable/Collector") {}
/**
 * @since 1.0.0
 ...
 * @category accessors
 */
export const addAll = tranferables => Effect.servicesWith(services => {
 ...
 * @category Getter
 */
export const getterAddAll = f => Getter.transformOrFail(e => Effect.servicesWith(services => {
  const collector = ServiceMap.getOrUndefined(services, Collector);
