...
declare const EventJournal_base: ServiceMap.ServiceClass<EventJournal, "effect/eventlog/EventJournal", {
    /**
...
declare const EventJournalError_base: new <A extends Record<string, any> = {}>(args: import("../../Types.ts").MatchRecord<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }, void, { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("../../Cause.ts").YieldableError & {
 ...
 * @category entry
 */
export declare const EntryId: Schema.brand<Schema.Uint8Array, "effect/eventlog/EventJournal/EntryId">;
/**
 * @since 4.0.0
 * @category entry
 */
...
declare const Entry_base: Schema.ExtendableClass<Entry, Schema.Struct<{
    readonly id: Schema.brand<Schema.Uint8Array, "effect/eventlog/EventJournal/EntryId">;
...
declare const RemoteEntry_base: Schema.ExtendableClass<RemoteEntry, Schema.Struct<{
