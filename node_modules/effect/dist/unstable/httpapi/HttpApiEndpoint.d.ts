...
export interface HttpApiEndpoint<out Name extends string, out Method extends HttpMethod, out Path extends string, out Params extends Schema.Top = never, out Query extends Schema.Top = never, out Payload extends Schema.Top = never, out Headers extends Schema.Top = never, out Success extends Schema.Top = typeof HttpApiSchema.NoContent, out Error extends Schema.Top = typeof BadRequestNoContent, in out Middleware = never, out MiddlewareR = never> extends Pipeable {
     ...
     */
    middleware<I extends HttpApiMiddleware.AnyId, S>(middleware: ServiceMap.Key<I, S>): HttpApiEndpoint<Name, Method, Path, Params, Query, Payload, Headers, Success, Error, Middleware | I, HttpApiMiddleware.ApplyServices<I, MiddlewareR>>;
    /**
     * Add an annotation on the endpoint.
     */
    annotate<I, S>(key: ServiceMap.Key<I, S>, value: Types.NoInfer<S>): HttpApiEndpoint<Name, Method, Path, Params, Query, Payload, Headers, Success, Error, Middleware, MiddlewareR>;
    /**
     * Merge the annotations of the endpoint with the provided service map.
     */
    annotateMerge<I>(annotations: ServiceMap.ServiceMap<I>): HttpApiEndpoint<Name, Method, Path, Params, Query, Payload, Headers, Success, Error, Middleware, MiddlewareR>;
}
/**
 * @since 4.0.0
 * @category models
 ...
 * @category models
 */
export type ClientRequest<Params extends Schema.Top, Query extends Schema.Top, Payload extends Schema.Top, Headers extends Schema.Top, WithResponse extends boolean> = (([Params["Type"]] extends [never] ? {} : {
...
}) => HttpApiEndpoint<Name, Method, Path, Params extends Schema.Struct.Fields ? Schema.Struct<Params> : Params, Query extends Schema.Struct.Fields ? Schema.Struct<Query> : Query, Payload extends Schema.Struct.Fields ? Schema.Struct<Payload> : Payload extends ReadonlyArray<Schema.Top> ? Payload[number] : Payload, Headers extends Schema.Struct.Fields ? Schema.Struct<Headers> : Headers, Success extends ReadonlyArray<Schema.Top> ? Success[number] : Success, (Error extends ReadonlyArray<Schema.Top> ? Error[number] : Error) | typeof BadRequestNoContent>;
/**
 * @since 4.0.0
 * @category constructors
 */
...
export declare const post: <const Name extends string, const Path extends HttpRouter.PathInput, Params extends ParamsConstraint = never, Query extends QueryConstraint = never, Payload extends SuccessConstraint = never, Headers extends HeadersConstraint = never, const Success extends SuccessConstraint = HttpApiSchema.NoContent, const Error extends ErrorConstraint = never>(name: Name, path: Path, options?: {
    ...
    readonly success?: Success | undefined;
    readonly error?: Error | undefined;
} | undefined) => HttpApiEndpoint<Name, "POST", Path, Params extends Schema.Struct.Fields ? Schema.Struct<Params> : Params, Query extends Schema.Struct.Fields ? Schema.Struct<Query> : Query, Payload extends Schema.Struct.Fields ? Schema.Struct<Payload> : Payload extends readonly Schema.Top[] ? Payload[number] : Payload, Headers extends Schema.Struct.Fields ? Schema.Struct<Headers> : Headers, Success extends readonly Schema.Top[] ? Success[number] : Success, HttpApiSchema.asNoContent<typeof import("./HttpApiError.ts").BadRequest> | (Error extends readonly Schema.Top[] ? Error[number] : Error), never, never>;
/**
 * @since 4.0.0
 * @category constructors
 */
export declare const put: <const Name extends string, const Path extends HttpRouter.PathInput, Params extends ParamsConstraint = never, Query extends QueryConstraint = never, Payload extends SuccessConstraint = never, Headers extends HeadersConstraint = never, const Success extends SuccessConstraint = HttpApiSchema.NoContent, const Error extends ErrorConstraint = never>(name: Name, path: Path, options?: {
    ...
    readonly success?: Success | undefined;
    readonly error?: Error | undefined;
} | undefined) => HttpApiEndpoint<Name, "PUT", Path, Params extends Schema.Struct.Fields ? Schema.Struct<Params> : Params, Query extends Schema.Struct.Fields ? Schema.Struct<Query> : Query, Payload extends Schema.Struct.Fields ? Schema.Struct<Payload> : Payload extends readonly Schema.Top[] ? Payload[number] : Payload, Headers extends Schema.Struct.Fields ? Schema.Struct<Headers> : Headers, Success extends readonly Schema.Top[] ? Success[number] : Success, HttpApiSchema.asNoContent<typeof import("./HttpApiError.ts").BadRequest> | (Error extends readonly Schema.Top[] ? Error[number] : Error), never, never>;
/**
 * @since 4.0.0
 * @category constructors
 */
export declare const patch: <const Name extends string, const Path extends HttpRouter.PathInput, Params extends ParamsConstraint = never, Query extends QueryConstraint = never, Payload extends SuccessConstraint = never, Headers extends HeadersConstraint = never, const Success extends SuccessConstraint = HttpApiSchema.NoContent, const Error extends ErrorConstraint = never>(name: Name, path: Path, options?: {
    ...
    readonly success?: Success | undefined;
    readonly error?: Error | undefined;
} | undefined) => HttpApiEndpoint<Name, "PATCH", Path, Params extends Schema.Struct.Fields ? Schema.Struct<Params> : Params, Query extends Schema.Struct.Fields ? Schema.Struct<Query> : Query, Payload extends Schema.Struct.Fields ? Schema.Struct<Payload> : Payload extends readonly Schema.Top[] ? Payload[number] : Payload, Headers extends Schema.Struct.Fields ? Schema.Struct<Headers> : Headers, Success extends readonly Schema.Top[] ? Success[number] : Success, HttpApiSchema.asNoContent<typeof import("./HttpApiError.ts").BadRequest> | (Error extends readonly Schema.Top[] ? Error[number] : Error), never, never>;
declare const del: <const Name extends string, const Path extends HttpRouter.PathInput, Params extends ParamsConstraint = never, Query extends QueryConstraint = never, Payload extends SuccessConstraint = never, Headers extends HeadersConstraint = never, const Success extends SuccessConstraint = HttpApiSchema.NoContent, const Error extends ErrorConstraint = never>(name: Name, path: Path, options?: {
    readonly params?: Params | undefined;
    readonly query?: Query | undefined;
    readonly headers?: Headers | undefined;
    readonly payload?: Payload | undefined;
    readonly success?: Success | undefined;
    readonly error?: Error | undefined;
} | undefined) => HttpApiEndpoint<Name, "DELETE", Path, Params extends Schema.Struct.Fields ? Schema.Struct<Params> : Params, Query extends Schema.Struct.Fields ? Schema.Struct<Query> : Query, Payload extends Schema.Struct.Fields ? Schema.Struct<Payload> : Payload extends readonly Schema.Top[] ? Payload[number] : Payload, Headers extends Schema.Struct.Fields ? Schema.Struct<Headers> : Headers, Success extends readonly Schema.Top[] ? Success[number] : Success, HttpApiSchema.asNoContent<typeof import("./HttpApiError.ts").BadRequest> | (Error extends readonly Schema.Top[] ? Error[number] : Error), never, never>;
export { 
/**
 * @since 4.0.0
 * @category constructors
...
export declare const head: <const Name extends string, const Path extends HttpRouter.PathInput, Params extends ParamsConstraint = never, Query extends QueryConstraint = never, Payload extends Record<string, Schema.Encoder<string | readonly string[] | undefined, unknown>> = never, Headers extends HeadersConstraint = never, const Success extends SuccessConstraint = HttpApiSchema.NoContent, const Error extends ErrorConstraint = never>(name: Name, path: Path, options?: {
    ...
    readonly success?: Success | undefined;
    readonly error?: Error | undefined;
} | undefined) => HttpApiEndpoint<Name, "HEAD", Path, Params extends Schema.Struct.Fields ? Schema.Struct<Params> : Params, Query extends Schema.Struct.Fields ? Schema.Struct<Query> : Query, Payload extends Schema.Struct.Fields ? Schema.Struct<Payload> : Payload extends readonly Schema.Top[] ? Payload[number] : Payload, Headers extends Schema.Struct.Fields ? Schema.Struct<Headers> : Headers, Success extends readonly Schema.Top[] ? Success[number] : Success, HttpApiSchema.asNoContent<typeof import("./HttpApiError.ts").BadRequest> | (Error extends readonly Schema.Top[] ? Error[number] : Error), never, never>;
/**
 * @since 4.0.0
 * @category constructors
 */
export declare const options: <const Name extends string, const Path extends HttpRouter.PathInput, Params extends ParamsConstraint = never, Query extends QueryConstraint = never, Payload extends Record<string, Schema.Encoder<string | readonly string[] | undefined, unknown>> = never, Headers extends HeadersConstraint = never, const Success extends SuccessConstraint = HttpApiSchema.NoContent, const Error extends ErrorConstraint = never>(name: Name, path: Path, options?: {
    ...
    readonly success?: Success | undefined;
    readonly error?: Error | undefined;
} | undefined) => HttpApiEndpoint<Name, "OPTIONS", Path, Params extends Schema.Struct.Fields ? Schema.Struct<Params> : Params, Query extends Schema.Struct.Fields ? Schema.Struct<Query> : Query, Payload extends Schema.Struct.Fields ? Schema.Struct<Payload> : Payload extends readonly Schema.Top[] ? Payload[number] : Payload, Headers extends Schema.Struct.Fields ? Schema.Struct<Headers> : Headers, Success extends readonly Schema.Top[] ? Success[number] : Success, HttpApiSchema.asNoContent<typeof import("./HttpApiError.ts").BadRequest> | (Error extends readonly Schema.Top[] ? Error[number] : Error), never, never>;
