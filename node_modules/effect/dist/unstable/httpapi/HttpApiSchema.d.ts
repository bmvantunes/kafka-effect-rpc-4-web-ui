 ...
 * @since 4.0.0
 */
export declare function status(code: number): <S extends Schema.Top>(self: S) => S["~rebuild.out"];
/**
 ...
 * @since 4.0.0
 */
export interface asMultipartStream<S extends Schema.Top> extends Schema.brand<S["~rebuild.out"], MultipartStreamTypeId> {
}
/**
...
}): <S extends Schema.Top>(self: S) => S["~rebuild.out"];
/**
...
export declare function asFormUrlEncoded(options?: {
    ...
    readonly Encoded: Record<string, string | ReadonlyArray<string> | undefined>;
