 ...
 */
export class Identifier extends /*#__PURE__*/ServiceMap.Service()("effect/httpapi/OpenApi/Identifier") {}
/**
 * @since 4.0.0
 * @category annotations
 */
export class Title extends /*#__PURE__*/ServiceMap.Service()("effect/httpapi/OpenApi/Title") {}
/**
 * @since 4.0.0
 * @category annotations
 */
export class Version extends /*#__PURE__*/ServiceMap.Service()("effect/httpapi/OpenApi/Version") {}
/**
 * @since 4.0.0
 * @category annotations
 */
export class Description extends /*#__PURE__*/ServiceMap.Service()("effect/httpapi/OpenApi/Description") {}
/**
 * @since 4.0.0
 * @category annotations
 */
export class License extends /*#__PURE__*/ServiceMap.Service()("effect/httpapi/OpenApi/License") {}
/**
 * @since 4.0.0
 * @category annotations
 */
export class ExternalDocs extends /*#__PURE__*/ServiceMap.Service()("effect/httpapi/OpenApi/ExternalDocs") {}
/**
 * @since 4.0.0
 * @category annotations
 */
export class Servers extends /*#__PURE__*/ServiceMap.Service()("effect/httpapi/OpenApi/Servers") {}
/**
 * @since 4.0.0
 * @category annotations
 */
export class Format extends /*#__PURE__*/ServiceMap.Service()("effect/httpapi/OpenApi/Format") {}
/**
 * @since 4.0.0
 * @category annotations
 */
export class Summary extends /*#__PURE__*/ServiceMap.Service()("effect/httpapi/OpenApi/Summary") {}
/**
 * @since 4.0.0
 * @category annotations
 */
export class Deprecated extends /*#__PURE__*/ServiceMap.Service()("effect/httpapi/OpenApi/Deprecated") {}
/**
 * @since 4.0.0
 * @category annotations
 */
export class Override extends /*#__PURE__*/ServiceMap.Service()("effect/httpapi/OpenApi/Override") {}
/**
 * @since 4.0.0
 * @category annotations
 */
export const Exclude = /*#__PURE__*/ServiceMap.Reference("effect/httpapi/OpenApi/Exclude", {
 ...
 * @category annotations
 */
export class Transform extends /*#__PURE__*/ServiceMap.Service()("effect/httpapi/OpenApi/Transform") {}
  ...
  return options => {
    ...
    for (const [key, tag] of entries) {
      if (options[key] !== undefined) {
        context = ServiceMap.add(context, tag, options[key]);
      }
    }
    return context;
  };
  ...
  HttpApi.reflect(api, {
    ...
    onEndpoint({
      ...
      let op = {
        ...
        operationId: ServiceMap.getOrElse(endpoint.annotations, Identifier, () => group.topLevel ? endpoint.name : `${group.identifier}.${endpoint.name}`),
        parameters: [],
        security: [],
        responses: {}
      };
...
const makeSecurityScheme = security => {
  ...
  switch (security._tag) {
    ...
    case "Bearer":
      {
        const format = ServiceMap.getOption(security.annotations, Format).pipe(Option.map(format => ({
          bearerFormat: format
