...
const makeClient = (api, options) => Effect.gen(function* () {
  ...
  HttpApi.reflect(api, {
    ...
    onEndpoint(onEndpointOptions) {
      ...
      const encodePayload = Arr.isArrayNonEmpty(payloadSchemas) ? HttpMethod.hasBody(endpoint.method) ? Schema.encodeUnknownEffect(getEncodePayloadSchema(payloadSchemas)) : Schema.encodeUnknownEffect(Schema.Union(payloadSchemas)) : undefined;
 ...
 * @category constructors
 */
export const urlBuilder = options => {
  return (_, endpoint, request) => {
