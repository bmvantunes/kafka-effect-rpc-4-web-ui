...
declare const Identifier_base: ServiceMap.ServiceClass<Identifier, "effect/httpapi/OpenApi/Identifier", string>;
/**
 * @since 4.0.0
...
declare const Title_base: ServiceMap.ServiceClass<Title, "effect/httpapi/OpenApi/Title", string>;
/**
 * @since 4.0.0
 * @category annotations
 */
...
declare const Version_base: ServiceMap.ServiceClass<Version, "effect/httpapi/OpenApi/Version", string>;
/**
 * @since 4.0.0
 * @category annotations
 */
...
declare const Description_base: ServiceMap.ServiceClass<Description, "effect/httpapi/OpenApi/Description", string>;
/**
 * @since 4.0.0
 * @category annotations
 */
...
declare const License_base: ServiceMap.ServiceClass<License, "effect/httpapi/OpenApi/License", OpenAPISpecLicense>;
/**
 * @since 4.0.0
 * @category annotations
 */
...
declare const ExternalDocs_base: ServiceMap.ServiceClass<ExternalDocs, "effect/httpapi/OpenApi/ExternalDocs", OpenAPISpecExternalDocs>;
/**
 * @since 4.0.0
 * @category annotations
 */
...
declare const Servers_base: ServiceMap.ServiceClass<Servers, "effect/httpapi/OpenApi/Servers", readonly OpenAPISpecServer[]>;
/**
 * @since 4.0.0
 * @category annotations
 */
...
declare const Format_base: ServiceMap.ServiceClass<Format, "effect/httpapi/OpenApi/Format", string>;
/**
 * @since 4.0.0
 * @category annotations
 */
...
declare const Summary_base: ServiceMap.ServiceClass<Summary, "effect/httpapi/OpenApi/Summary", string>;
/**
 * @since 4.0.0
 * @category annotations
 */
...
declare const Deprecated_base: ServiceMap.ServiceClass<Deprecated, "effect/httpapi/OpenApi/Deprecated", boolean>;
/**
 * @since 4.0.0
 * @category annotations
 */
...
declare const Override_base: ServiceMap.ServiceClass<Override, "effect/httpapi/OpenApi/Override", Record<string, unknown>>;
/**
 * @since 4.0.0
 * @category annotations
 */
 ...
 * @category annotations
 */
export declare const Exclude: ServiceMap.Reference<boolean>;
declare const Transform_base: ServiceMap.ServiceClass<Transform, "effect/httpapi/OpenApi/Transform", (openApiSpec: Record<string, any>) => Record<string, any>>;
/**
