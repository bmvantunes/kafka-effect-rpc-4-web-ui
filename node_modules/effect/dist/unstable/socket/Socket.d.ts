 ...
 * @category tags
 */
export declare const Socket: ServiceMap.Service<Socket, Socket>;
/**
 * @since 4.0.0
 * @category models
 */
...
declare const SocketReadError_base: Schema.ErrorClass<SocketReadError, Schema.Struct<{
...
declare const SocketWriteError_base: Schema.ErrorClass<SocketWriteError, Schema.Struct<{
...
declare const SocketOpenError_base: Schema.ErrorClass<SocketOpenError, Schema.Struct<{
...
declare const SocketCloseError_base: Schema.ErrorClass<SocketCloseError, Schema.Struct<{
...
declare const SocketError_base: Schema.ErrorClass<SocketError, Schema.Struct<{
...
declare const WebSocket_base: ServiceMap.ServiceClass<WebSocket, "~effect/socket/Socket/WebSocket", globalThis.WebSocket>;
/**
 * @since 4.0.0
 * @category tags
 */
...
declare const WebSocketConstructor_base: ServiceMap.ServiceClass<WebSocketConstructor, "@effect/platform/Socket/WebSocketConstructor", (url: string, protocols?: string | Array<string> | undefined) => globalThis.WebSocket>;
/**
 * @since 4.0.0
 * @category tags
 */
 ...
 * @category fiber refs
 */
export declare const SendQueueCapacity: ServiceMap.Reference<number>;
/**
 * @since 4.0.0
 * @category models
 */
