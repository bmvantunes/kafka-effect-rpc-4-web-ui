 ...
 */
export declare const ExitCode: Brand.Constructor<ExitCode>;
/**
 * @since 4.0.0
 * @category Models
 */
 ...
 * @category Constructors
 */
export declare const ProcessId: Brand.Constructor<ProcessId>;
declare const HandleTypeId = "~effect/ChildProcessSpawner/ChildProcessHandle";
/**
 ...
 * @category Models
 */
export declare const make: (spawn: ChildProcessSpawner["Service"]["spawn"]) => ChildProcessSpawner["Service"];
declare const ChildProcessSpawner_base: ServiceMap.ServiceClass<ChildProcessSpawner, "effect/process/ChildProcessSpawner", {
    /**
...
export {};
//# sourceMappingURL=ChildProcessSpawner.d.ts.map