...
declare const RpcClientDefect_base: Schema.ErrorClass<RpcClientDefect, Schema.Struct<{
...
declare const RpcClientError_base: Schema.ErrorClass<RpcClientError, Schema.Struct<{
