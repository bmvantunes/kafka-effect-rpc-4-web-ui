...
declare const InitialMessage_base: ServiceMap.ServiceClass<InitialMessage, "effect/rpc/RpcWorker/InitialMessage", Effect.Effect<readonly [data: unknown, transfers: readonly Transferable[]], never, never>>;
/**
 * @since 4.0.0
