 ...
 * @category models
 */
export interface ServiceClass<Self, Name extends string, Provides, E extends Schema.Top, ClientError, Requires> extends ServiceMap.Service<Self, RpcMiddleware<Provides, E["Type"], Requires>> {
...
export declare const Service: <Self, Config extends {
    ...
    provides: never;
    clientError: never;
}>() => <const Name extends string, Error extends Schema.Top = Schema.Never, RequiredForClient extends boolean = false>(id: Name, options?: {
    readonly error?: Error | undefined;
    readonly requiredForClient: RequiredForClient | undefined;
} | undefined) => ServiceClass<Self, Name, "provides" extends keyof Config ? Config["provides"] : never, Error, "clientError" extends keyof Config ? Config["clientError"] : never, "requires" extends keyof Config ? Config["requires"] : never>;
/**
 * @since 4.0.0
 * @category client
 */
export declare const layerClient: <Id extends AnyId, S, R, EX = never, RX = never>(tag: ServiceMap.Key<Id, S>, service: RpcMiddlewareClient<Id[TypeId]["error"]["Type"], Id[TypeId]["clientError"], R> | Effect.Effect<RpcMiddlewareClient<Id[TypeId]["error"]["Type"], Id[TypeId]["clientError"], R>, EX, RX>) => Layer.Layer<ForClient<Id>, EX, R | Exclude<RX, Scope>>;
