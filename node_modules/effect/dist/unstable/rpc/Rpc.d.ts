...
export interface Rpc<in out Tag extends string, out Payload extends Schema.Top = Schema.Void, out Success extends Schema.Top = Schema.Void, out Error extends Schema.Top = Schema.Never, out Middleware extends RpcMiddleware.AnyService = never, out Requires = never> extends Pipeable {
     ...
     */
    annotate<I, S>(tag: ServiceMap.Key<I, S>, value: S): Rpc<Tag, Payload, Success, Error, Middleware, Requires>;
    /**
 ...
 * @category models
 */
export type Middleware<R> = R extends Rpc<infer _Tag, infer _Payload, infer _Success, infer _Error, infer _Middleware, infer _Requires> ? ServiceMap.Service.Identifier<_Middleware> : never;
/**
 * @since 4.0.0
 * @category models
 */
...
} ? RpcMiddleware.ForClient<ServiceMap.Service.Identifier<_Middleware>> : never : never;
/**
 * @since 4.0.0
 * @category models
 */
