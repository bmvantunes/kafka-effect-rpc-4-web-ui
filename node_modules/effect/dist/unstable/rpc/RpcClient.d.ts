 ...
 * @category headers
 */
export declare const CurrentHeaders: ServiceMap.Reference<Headers.Headers>;
/**
 * @since 4.0.0
 * @category headers
 */
...
declare const Protocol_base: ServiceMap.ServiceClass<Protocol, "effect/rpc/RpcClient/Protocol", {
