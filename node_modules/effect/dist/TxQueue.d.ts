...
import { type ExcludeDone } from "./Pull.ts";
...
declare const EnqueueTypeId = "~effect/transactions/TxQueue/Enqueue";
declare const DequeueTypeId = "~effect/transactions/TxQueue/Dequeue";
declare const TypeId = "~effect/transactions/TxQueue";
/**
