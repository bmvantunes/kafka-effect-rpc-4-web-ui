 ...
 * @category Services
 */
export const servicesWith = f => fromTransform((upstream, scope) => Effect.servicesWith(services => toTransform(f(services))(upstream, scope)));
/**
 ...
 * @category Services
 */
export const provideServices = /*#__PURE__*/dual(2, (self, services) => fromTransform((upstream, scope) => Effect.map(Effect.provideServices(toTransform(self)(upstream, scope), services), Effect.provideServices(services))));
/**
 * @since 4.0.0
 * @category Services
 */
 ...
 * @category Services
 */
export const provide = /*#__PURE__*/dual(args => isChannel(args[0]), (self, layer, options) => ServiceMap.isServiceMap(layer) ? provideServices(self, layer) : fromTransform((upstream, scope) => Effect.flatMap(options?.local ? Layer.buildWithMemoMap(layer, Layer.makeMemoMapUnsafe(), scope) : Layer.buildWithScope(layer, scope), services => Effect.map(Effect.provideServices(toTransform(self)(upstream, scope), services), Effect.provideServices(services)))));
/**
 * @since 2.0.0
 * @category Services
 */
export const updateServices = /*#__PURE__*/dual(2, (self, f) => fromTransform((upstream, scope) => Effect.servicesWith(services => {
...
export const toPull = /*#__PURE__*/Effect.fnUntraced(function* (self) {
  ...
  return pull.pipe(Effect.provideServices(context), semaphore.withPermits(1));
},
/*#__PURE__*/
