...
const Proto = {
  ...
  get withRequirements() {
    const self = this;
    return effect.servicesWith(services => effect.succeed(makeProto(self.steps.map(step => ({
      ...step,
      provide: Layer.isLayer(step.provide) ? Layer.provide(step.provide, Layer.succeedServices(services)) : step.provide
    })))));
  },
  pipe() {
 ...
 * @category Metadata
 */
export const CurrentMetadata = /*#__PURE__*/ServiceMap.Reference("effect/ExecutionPlan/CurrentMetadata", {
