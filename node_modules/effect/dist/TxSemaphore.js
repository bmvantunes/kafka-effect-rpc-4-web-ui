...
const makeTxSemaphore = (permitsRef, capacity) => {
 ...
 */
export const make = permits => Effect.gen(function* () {
  if (permits < 0) {
 ...
 */
export const available = self => TxRef.get(self.permitsRef);
/**
 ...
 * @category combinators
 */
export const capacity = self => Effect.succeed(self.capacity);
/**
 ...
 * @category combinators
 */
export const tryAcquire = self => TxRef.modify(self.permitsRef, permits => {
  if (permits > 0) {
 ...
 * @category combinators
 */
export const tryAcquireN = (self, n) => {
  if (n <= 0) {
    return Effect.die(new Error("Number of permits must be positive"));
  }
  return TxRef.modify(self.permitsRef, permits => {
    if (permits >= n) {
 ...
 * @category combinators
 */
export const release = self => TxRef.update(self.permitsRef, permits => permits >= self.capacity ? permits : permits + 1);
/**
 ...
 * @category combinators
 */
export const releaseN = (self, n) => {
  if (n <= 0) {
    return Effect.die(new Error("Number of permits must be positive"));
  }
  return TxRef.update(self.permitsRef, permits => {
 ...
 * @category guards
 */
export const isTxSemaphore = u => typeof u === "object" && u !== null && TypeId in u;
//# sourceMappingURL=TxSemaphore.js.map