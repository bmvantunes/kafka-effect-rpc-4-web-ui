...
export const parse = (cron, tz) => {
  ...
  const zone = tz === undefined || dateTime.isTimeZone(tz) ? Result.succeed(tz) : UndefinedOr.match(dateTime.zoneFromString(tz), {
    onUndefined: () => Result.fail(new CronParseError({
