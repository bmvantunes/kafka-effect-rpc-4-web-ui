 ...
 * @category Metadata
 */
export const CurrentMetadata = /*#__PURE__*/ServiceMap.Reference("effect/Schedule/CurrentMetadata", {
...
export const fixed = interval => {
  ...
  return fromStepWithMetadata(effect.succeed(meta => effect.succeed([meta.attempt - 1, window === 0 ? Duration.zero : Duration.millis(window - meta.elapsed % window)])));
};
/**
