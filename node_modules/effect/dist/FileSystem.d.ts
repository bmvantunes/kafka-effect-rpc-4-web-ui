...
declare const TypeId = "~effect/platform/FileSystem";
/**
 ...
 * @category tag
 */
export declare const FileSystem: ServiceMap.Service<FileSystem, FileSystem>;
/**
 ...
 * @category File
 */
export declare const FileTypeId = "~effect/platform/FileSystem/File";
/**
...
declare const WatchBackend_base: ServiceMap.ServiceClass<WatchBackend, "effect/platform/FileSystem/WatchBackend", {
