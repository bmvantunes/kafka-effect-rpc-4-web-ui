...
export declare const provideServices: {
     ...
     * @category Services
     */
    <Provided>(services: ServiceMap.ServiceMap<Provided>): <A, In, L, E, R>(self: Sink<A, In, L, E, R>) => Sink<A, In, L, E, Exclude<R, Provided>>;
    /**
     * @since 4.0.0
     * @category Services
     */
    <A, In, L, E, R, Provided>(self: Sink<A, In, L, E, R>, services: ServiceMap.ServiceMap<Provided>): Sink<A, In, L, E, Exclude<R, Provided>>;
};
/**
 * @since 4.0.0
 * @category Services
...
export declare const provideService: {
     ...
     * @category Services
     */
    <A, In, L, E, R, I, S>(self: Sink<A, In, L, E, R>, key: ServiceMap.Key<I, S>, value: Types.NoInfer<S>): Sink<A, In, L, E, Exclude<R, I>>;
};
/**
 * @since 2.0.0
