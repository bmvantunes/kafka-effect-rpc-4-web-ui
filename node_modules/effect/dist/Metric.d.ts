 ...
 * @category References
 */
export declare const CurrentMetricAttributes: ServiceMap.Reference<Readonly<Record<string, string>>>;
/**
 ...
 * @category References
 */
export declare const MetricRegistry: ServiceMap.Reference<Map<string, Metric.Metadata<any, any>>>;
declare const TypeId = "~effect/observability/Metric";
/**
 ...
 * @category Constructors
 */
export declare const histogram: (name: string, options: {
    readonly description?: string | undefined;
    readonly attributes?: Metric.Attributes | undefined;
 ...
 * @category Constructors
 */
export declare const summary: (name: string, options: {
    readonly description?: string | undefined;
    readonly attributes?: Metric.Attributes | undefined;
 ...
 * @category Constructors
 */
export declare const summaryWithTimestamp: (name: string, options: {
    readonly description?: string | undefined;
    readonly attributes?: Metric.Attributes | undefined;
    readonly maxAge: Duration.Input;
    readonly maxSize: number;
 ...
 * @category Constructors
 */
export declare const timer: (name: string, options?: {
    readonly description?: string | undefined;
    readonly attributes?: Metric.Attributes | undefined;
    readonly boundaries?: ReadonlyArray<number>;
...
export declare const mapInput: {
     ...
     * @category Mapping
     */
    <Input, Input2 extends Input>(f: (input: Input2, context: ServiceMap.ServiceMap<never>) => Input): <State>(self: Metric<Input, State>) => Metric<Input2, State>;
    /**
     * Returns a new metric that is powered by this one, but which accepts updates
     * of the specified new type, which must be transformable to the input type of
     * this metric.
     ...
     * @category Mapping
     */
    <Input, State, Input2>(self: Metric<Input, State>, f: (input: Input2, context: ServiceMap.ServiceMap<never>) => Input): Metric<Input2, State>;
};
/**
 * Returns a new metric that is powered by this one, but which accepts updates
 ...
 * @category Runtime Metrics
 */
export declare const FiberRuntimeMetrics: ServiceMap.Reference<FiberRuntimeMetricsService | undefined>;
/**
