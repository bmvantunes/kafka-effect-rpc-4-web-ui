 ...
 * ```
 */
export class ParentSpan extends /*#__PURE__*/ServiceMap.Service()(ParentSpanKey) {}
/**
 * @since 2.0.0
 ...
 * ```
 */
export const DisablePropagation = /*#__PURE__*/ServiceMap.Reference("effect/Tracer/DisablePropagation", {
 ...
 * @since 4.0.0
 */
export const CurrentTraceLevel = /*#__PURE__*/ServiceMap.Reference("effect/Tracer/CurrentTraceLevel", {
  defaultValue: () => "Info"
});
/**
 ...
 * @since 4.0.0
 */
export const MinimumTraceLevel = /*#__PURE__*/ServiceMap.Reference("effect/Tracer/MinimumTraceLevel", {
  defaultValue: () => "All"
});
/**
 * @since 4.0.0
 ...
 * ```
 */
export const Tracer = /*#__PURE__*/ServiceMap.Reference(TracerKey, {
  defaultValue: () => make({
