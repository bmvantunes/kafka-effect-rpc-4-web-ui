...
declare const TypeId = "~effect/data/Result";
/**
 ...
 * @since 4.0.0
 */
export interface ResultUnify<T extends {
...
export declare namespace Result {
     ...
     * @category Type Level
     */
    type Failure<T extends Result<any, any>> = [T] extends [Result<infer _A, infer _E>] ? _E : never;
    /**
     ...
     * @category Type Level
     */
    type Success<T extends Result<any, any>> = [T] extends [Result<infer _A, infer _E>] ? _A : never;
}
/**
...
declare const void_: Result<void>;
export { 
/**
 ...
 * @since 4.0.0
 */
export declare const failVoid: Result<never, void>;
/**
 ...
 * @since 4.0.0
 */
export declare const fromNullishOr: {
    /**
     * Converts a possibly `null` or `undefined` value into a `Result`.
     *
     * - Non-nullish values become `Success<NonNullable<A>>`
...
export declare const filterOrFail: {
     ...
     * @category Filtering
     */
    <A, B extends A, E2>(refinement: Refinement<NoInfer<A>, B>, orFailWith: (value: NoInfer<A>) => E2): <E>(self: Result<A, E>) => Result<B, E2 | E>;
    /**
     * Validates the success value of a `Result` using a predicate, failing with a
     * custom error if the predicate returns `false`.
     *
     ...
     * @category Filtering
     */
    <A, E, B extends A, E2>(self: Result<A, E>, refinement: Refinement<A, B>, orFailWith: (value: A) => E2): Result<B, E | E2>;
    /**
     * Validates the success value of a `Result` using a predicate, failing with a
     * custom error if the predicate returns `false`.
     *
 ...
 * @since 4.0.0
 */
export declare const all: <const I extends Iterable<Result<any, any>> | Record<string, Result<any, any>>>(input: I) => [I] extends [ReadonlyArray<Result<any, any>>] ? Result<{
    -readonly [K in keyof I]: [I[K]] extends [Result<infer R, any>] ? R : never;
}, I[number] extends never ? never : [I[number]] extends [Result<any, infer L>] ? L : never> : [I] extends [Iterable<Result<infer R, infer L>>] ? Result<Array<R>, L> : Result<{
    -readonly [K in keyof I]: [I[K]] extends [Result<infer R, any>] ? R : never;
...
declare const let_: {
    <N extends string, R extends object, B>(name: Exclude<N, keyof R>, f: (r: NoInfer<R>) => B): <L>(self: Result<R, L>) => Result<{
        [K in N | keyof R]: K extends keyof R ? R[K] : B;
    }, L>;
    <R extends object, L, N extends string, B>(self: Result<R, L>, name: Exclude<N, keyof R>, f: (r: NoInfer<R>) => B): Result<{
        [K in N | keyof R]: K extends keyof R ? R[K] : B;
    }, L>;
};
export { 
 ...
 * @category Transposing
 */
export declare const transposeMapOption: (<A, B, E = never>(f: (self: A) => Result<B, E>) => (self: Option<A>) => Result<Option<B>, E>) & (<A, B, E = never>(self: Option<A>, f: (self: A) => Result<B, E>) => Result<Option<B>, E>);
/**
 ...
 * @since 4.0.0
 */
export declare const succeedNone: Result<Option<never>, never>;
/**
