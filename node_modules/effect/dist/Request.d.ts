 ...
 * @category constructors
 */
export declare const Class: new <A extends Record<string, any>, Success, Error = never, ServiceMap = never>(args: Types.Equals<Omit<A, keyof Request<unknown, unknown>>, {}> extends true ? void : {
    readonly [P in keyof A as P extends keyof Request<any, any, any> ? never : P]: A[P];
}) => Request<Success, Error, ServiceMap> & Readonly<A>;
/**
 * @example
 * ```ts
 * import { Request } from "effect"
