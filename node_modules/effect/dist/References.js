 ...
 * @since 4.0.0
 */
export const CurrentConcurrency = /*#__PURE__*/ServiceMap.Reference("effect/References/CurrentConcurrency", {
 ...
 * @category references
 */
export const CurrentStackFrame = /*#__PURE__*/ServiceMap.Reference("effect/References/CurrentStackFrame", {
 ...
 * @category references
 */
export const TracerEnabled = /*#__PURE__*/ServiceMap.Reference("effect/References/TracerEnabled", {
 ...
 * @category references
 */
export const TracerTimingEnabled = /*#__PURE__*/ServiceMap.Reference("effect/References/TracerTimingEnabled", {
  defaultValue: constTrue
});
/**
 ...
 * @category references
 */
export const TracerSpanAnnotations = /*#__PURE__*/ServiceMap.Reference("effect/References/TracerSpanAnnotations", {
  defaultValue: () => ({})
});
/**
 ...
 * @category references
 */
export const TracerSpanLinks = /*#__PURE__*/ServiceMap.Reference("effect/References/TracerSpanLinks", {
  defaultValue: () => []
});
/**
 ...
 * @category references
 */
export const CurrentLogAnnotations = /*#__PURE__*/ServiceMap.Reference("effect/References/CurrentLogAnnotations", {
  defaultValue: () => ({})
});
/**
 ...
 * @since 4.0.0
 */
export const CurrentLogLevel = /*#__PURE__*/ServiceMap.Reference("effect/References/CurrentLogLevel", {
  defaultValue: () => "Info"
});
/**
 ...
 * @since 4.0.0
 */
export const MinimumLogLevel = /*#__PURE__*/ServiceMap.Reference("effect/References/MinimumLogLevel", {
  defaultValue: () => "Info"
});
/**
 ...
 * @since 4.0.0
 */
export const UnhandledLogLevel = /*#__PURE__*/ServiceMap.Reference("effect/References/UnhandledLogLevel", {
  defaultValue: () => "Error"
});
/**
 ...
 * @category references
 */
export const CurrentLogSpans = /*#__PURE__*/ServiceMap.Reference("effect/References/CurrentLogSpans", {
  defaultValue: () => []
});
