 ...
 * @since 2.0.0
 */
export declare function flip<A>(O: Order<A>): Order<A>;
/**
 ...
 * @since 4.0.0
 */
export declare function alwaysEqual<A>(): Order<A>;
/**
 ...
 * @since 2.0.0
 */
export declare function combineAll<A>(collection: Iterable<Order<A>>): Order<A>;
/**
 ...
 * @since 4.0.0
 */
export declare function Tuple<const Elements extends ReadonlyArray<Order<any>>>(elements: Elements): Order<{
    readonly [I in keyof Elements]: [Elements[I]] extends [Order<infer A>] ? A : never;
}>;
/**
 ...
 * @since 4.0.0
 */
export declare function Array<A>(O: Order<A>): Order<ReadonlyArray<A>>;
/**
 ...
 * @since 4.0.0
 */
export declare function Struct<const R extends {
 ...
 * @since 2.0.0
 */
export declare const isLessThan: <A>(O: Order<A>) => {
 ...
 * @since 2.0.0
 */
export declare const isGreaterThan: <A>(O: Order<A>) => {
    (that: A): (self: A) => boolean;
    (self: A, that: A): boolean;
};
/**
 ...
 * @since 2.0.0
 */
export declare const isLessThanOrEqualTo: <A>(O: Order<A>) => {
    (that: A): (self: A) => boolean;
    (self: A, that: A): boolean;
};
/**
 ...
 * @since 2.0.0
 */
export declare const isGreaterThanOrEqualTo: <A>(O: Order<A>) => {
    (that: A): (self: A) => boolean;
    (self: A, that: A): boolean;
};
/**
 ...
 * @since 4.0.0
 */
export declare const isBetween: <A>(O: Order<A>) => {
    (options: {
        minimum: A;
        maximum: A;
    }): (self: A) => boolean;
