...
/** @internal */
export function withConstructorDefault(ast,
/**
 * The `input` parameters is `None` if the value is not present and
 * `Some(undefined)` if the value is present but undefined
 */
defaultValue) {
  const transformation = new Transformation.Transformation(new Getter.Getter(o => {
...
const bigIntToString = /*#__PURE__*/new Link(bigIntString, /*#__PURE__*/new Transformation.Transformation(/*#__PURE__*/Getter.transform(globalThis.BigInt), /*#__PURE__*/Getter.String()));
