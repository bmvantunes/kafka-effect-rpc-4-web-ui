 ...
 * @since 4.0.0
 */
export declare class Middleware<in out T, in out E, RDE, RDT, RET, REE> {
    readonly _tag = "Middleware";
    readonly decode: (effect: Effect.Effect<Option.Option<E>, Issue.Issue, RDE>, options: AST.ParseOptions) => Effect.Effect<Option.Option<T>, Issue.Issue, RDT>;
    readonly encode: (effect: Effect.Effect<Option.Option<T>, Issue.Issue, RET>, options: AST.ParseOptions) => Effect.Effect<Option.Option<E>, Issue.Issue, REE>;
    constructor(decode: (effect: Effect.Effect<Option.Option<E>, Issue.Issue, RDE>, options: AST.ParseOptions) => Effect.Effect<Option.Option<T>, Issue.Issue, RDT>, encode: (effect: Effect.Effect<Option.Option<T>, Issue.Issue, RET>, options: AST.ParseOptions) => Effect.Effect<Option.Option<E>, Issue.Issue, REE>);
    flip(): Middleware<E, T, RET, REE, RDE, RDT>;
}
declare const TypeId = "~effect/SchemaTransformation/Transformation";
/**
 ...
 * @since 4.0.0
 */
export declare class Transformation<in out T, in out E, RD = never, RE = never> {
 ...
 * @since 4.0.0
 */
export declare function isTransformation(u: unknown): u is Transformation<any, any, unknown, unknown>;
/**
 ...
 * @since 4.0.0
 */
export declare const make: <T, E, RD = never, RE = never>(options: {
    readonly decode: Getter.Getter<T, E, RD>;
    readonly encode: Getter.Getter<E, T, RE>;
 ...
 * @since 4.0.0
 */
export declare function transformOrFail<T, E, RD = never, RE = never>(options: {
 ...
 * @since 4.0.0
 */
export declare function transform<T, E>(options: {
 ...
 * @since 4.0.0
 */
export declare function transformOptional<T, E>(options: {
 ...
 * @since 4.0.0
 */
export declare function trim(): Transformation<string, string>;
/**
 ...
 * @since 4.0.0
 */
export declare function snakeToCamel(): Transformation<string, string>;
/**
 ...
 * @since 4.0.0
 */
export declare function toLowerCase(): Transformation<string, string>;
/**
 ...
 * @since 4.0.0
 */
export declare function toUpperCase(): Transformation<string, string>;
/**
 ...
 * @since 4.0.0
 */
export declare function capitalize(): Transformation<string, string>;
/**
 ...
 * @since 4.0.0
 */
export declare function uncapitalize(): Transformation<string, string>;
/**
 ...
 * @since 4.0.0
 */
export declare function splitKeyValue(options?: {
...
export declare function passthrough<T>(): Transformation<T, T>;
/**
 ...
 * @since 4.0.0
 */
export declare function passthroughSupertype<T extends E, E>(): Transformation<T, E>;
/**
 ...
 * @since 4.0.0
 */
export declare function passthroughSubtype<T, E extends T>(): Transformation<T, E>;
/**
 ...
 * @since 4.0.0
 */
export declare const numberFromString: Transformation<number, string, never, never>;
/**
 ...
 * @since 4.0.0
 */
export declare const bigintFromString: Transformation<bigint, string, never, never>;
/**
 ...
 * @since 4.0.0
 */
export declare const durationFromNanos: Transformation<Duration.Duration, bigint>;
/**
 ...
 * @since 4.0.0
 */
export declare const durationFromMillis: Transformation<Duration.Duration, number>;
/**
 ...
 * @since 4.0.0
 */
export declare function optionFromNullOr<T>(): Transformation<Option.Option<T>, T | null>;
/**
 ...
 * @since 4.0.0
 */
export declare function optionFromUndefinedOr<T>(): Transformation<Option.Option<T>, T | undefined>;
/**
 ...
 * @since 4.0.0
 */
export declare function optionFromNullishOr<T>(options?: {
 ...
 * @since 4.0.0
 */
export declare function optionFromOptionalKey<T>(): Transformation<Option.Option<T>, T>;
/**
 * Decodes `T | undefined` into `Option<T>` and encodes `Option<T>` back
 * to `T | undefined`.
 *
 ...
 * @since 4.0.0
 */
export declare function optionFromOptional<T>(): Transformation<Option.Option<T>, T | undefined>;
/**
 ...
 * @since 4.0.0
 */
export declare const urlFromString: Transformation<URL, string>;
/**
 ...
 * @since 4.0.0
 */
export declare const bigDecimalFromString: Transformation<BigDecimal.BigDecimal, string>;
/**
 ...
 * @since 4.0.0
 */
export declare const uint8ArrayFromBase64String: Transformation<Uint8Array<ArrayBufferLike>, string>;
/**
 ...
 * @since 4.0.0
 */
export declare const fromJsonString: Transformation<unknown, string, never, never>;
/**
 ...
 * @since 4.0.0
 */
export declare const fromFormData: Transformation<unknown, FormData, never, never>;
/**
 ...
 * @since 4.0.0
 */
export declare const fromURLSearchParams: Transformation<unknown, URLSearchParams, never, never>;
/**
 * @since 4.0.0
 */
export declare const timeZoneOffsetFromNumber: Transformation<DateTime.TimeZone.Offset, number>;
/**
 * @since 4.0.0
 */
export declare const timeZoneNamedFromString: Transformation<DateTime.TimeZone.Named, string>;
/**
 * @since 4.0.0
 */
export declare const timeZoneFromString: Transformation<DateTime.TimeZone, string>;
/**
 * @since 4.0.0
 */
export declare const dateTimeUtcFromString: Transformation<DateTime.Utc, string>;
/**
 * @since 4.0.0
 */
export declare const dateTimeZonedFromString: Transformation<DateTime.Zoned, string>;
export {};
//# sourceMappingURL=SchemaTransformation.d.ts.map