...
// =============================================================================
/** @internal */
export const Equivalence = /*#__PURE__*/Equ.make((a, b) => a.epochMillis === b.epochMillis);
/** @internal */
...
/** @internal */
export const makeZoned = /*#__PURE__*/UndefinedOr.liftThrowable(makeZonedUnsafe);
/** @internal */
export const make = /*#__PURE__*/UndefinedOr.liftThrowable(makeUnsafe);
...
/** @internal */
export const zoneMakeNamed = /*#__PURE__*/UndefinedOr.liftThrowable(zoneMakeNamedUnsafe);
/** @internal */
...
/** @internal */
export const setZoneNamed = /*#__PURE__*/dual(isDateTimeArgs, (self, zoneId, options) => UndefinedOr.map(zoneMakeNamed(zoneId), zone => setZone(self, zone, options)));
/** @internal */
