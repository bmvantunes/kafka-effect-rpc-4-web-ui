 ...
 */
export class CurrentTimeZone extends /*#__PURE__*/ServiceMap.Service()("effect/DateTime/CurrentTimeZone") {}
/**
 ...
 * ```
 */
export const setZoneCurrent = self => Effect.map(CurrentTimeZone.asEffect(), zone => setZone(self, zone));
/**
