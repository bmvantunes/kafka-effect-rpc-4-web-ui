 ...
 * @category combinators
 */
export declare function getUnsafe<A, E>(self: FiberHandle<A, E>): Fiber.Fiber<A, E> | undefined;
/**
 * Retrieve the fiber from the FiberHandle.
 *
 * @example
 ...
 * @category combinators
 */
export declare function get<A, E>(self: FiberHandle<A, E>): Effect.Effect<Fiber.Fiber<A, E> | undefined>;
/**
 * @example
 * ```ts
 * import { Effect, FiberHandle } from "effect"
