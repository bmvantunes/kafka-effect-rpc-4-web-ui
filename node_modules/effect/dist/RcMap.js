...
export const get = /*#__PURE__*/dual(2, (self, key) => Effect.uninterruptibleMask(restore => {
  ...
  if (o._tag === "Some") {
    ...
    self.lookup(key).pipe(Effect.runForkWith(ServiceMap.makeUnsafe(services)), Fiber.runIn(entry.scope)).addObserver(exit => Deferred.doneUnsafe(entry.deferred, exit));
  }
...
const release = (self, key, entry) => Effect.withFiber(fiber => {
  ...
  })), Effect.runForkWith(fiber.services), Fiber.runIn(self.scope));
  return Effect.void;
});
/**
