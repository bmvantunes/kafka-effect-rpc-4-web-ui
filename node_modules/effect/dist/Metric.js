 ...
 * @category References
 */
export const CurrentMetricAttributes = /*#__PURE__*/ServiceMap.Reference(CurrentMetricAttributesKey, {
  defaultValue: () => ({})
});
 ...
 * @category References
 */
export const MetricRegistry = /*#__PURE__*/ServiceMap.Reference(MetricRegistryKey, {
 ...
 * @category Constructors
 */
export const summary = (name, options) => mapInput(summaryWithTimestamp(name, options), (input, context) => [input, ServiceMap.get(context, InternalEffect.ClockRef).currentTimeMillisUnsafe()]);
/**
 * Creates a `Summary` metric that records observations and calculates quantiles
 ...
 * @category Utilities
 */
export const value = self => InternalEffect.flatMap(InternalEffect.services(), context => InternalEffect.sync(() => self.valueUnsafe(context)));
/**
 ...
 * @category Utilities
 */
export const modify = /*#__PURE__*/dual(2, (self, input) => InternalEffect.flatMap(InternalEffect.services(), context => InternalEffect.sync(() => self.modifyUnsafe(input, context))));
/**
 ...
 * @category Utilities
 */
export const update = /*#__PURE__*/dual(2, (self, input) => InternalEffect.servicesWith(services => InternalEffect.sync(() => self.updateUnsafe(input, services))));
/**
 ...
 * @category Attributes
 */
export const withAttributes = /*#__PURE__*/dual(2, (self, attributes) => new MetricTransform(self, context => self.valueUnsafe(addAttributesToServiceMap(context, attributes)), (input, context) => self.updateUnsafe(input, addAttributesToServiceMap(context, attributes)), (input, context) => self.modifyUnsafe(input, addAttributesToServiceMap(context, attributes))));
// Metric Snapshots
/**
 ...
 */
export const snapshot = /*#__PURE__*/InternalEffect.map(/*#__PURE__*/InternalEffect.services(), context => snapshotUnsafe(context));
/**
 ...
 * @category Debugging
 */
export const dump = /*#__PURE__*/InternalEffect.flatMap(/*#__PURE__*/InternalEffect.services(), context => {
 ...
 * @category Snapshotting
 */
export const snapshotUnsafe = services => {
 ...
 * @category Runtime Metrics
 */
export const FiberRuntimeMetrics = /*#__PURE__*/ServiceMap.Reference(InternalMetric.FiberRuntimeMetricsKey, {
...
function addAttributesToServiceMap(context, attributes) {
