...
declare const TypeId = "~effect/Deferred";
/**
...
declare const _await: <A, E>(self: Deferred<A, E>) => Effect<A, E>;
export { 
/**
 ...
 * @category getters
 */
export declare function poll<A, E>(self: Deferred<A, E>): Effect<Effect<A, E> | undefined>;
/**
