 ...
 * @category Environment
 */
export const servicesWith = internal.servicesWith;
/**
 ...
 * @category Environment
 */
export const provideServices = internal.provideServices;
/**
 ...
 * @category ServiceMap
 */
export const updateServices = internal.updateServices;
/**
...
export const transactionWith = f => withFiber(fiber => {
  ...
  return uninterruptibleMask(restore => flatMap(whileLoop({
    while: () => !result,
    body: constant(restore(suspend(() => f(state))).pipe(provideService(Transaction, state), tapCause(() => {
 ...
 * ```
 */
export const retryTransaction = /*#__PURE__*/flatMap(/*#__PURE__*/Transaction.asEffect(), state => {
  state.retry = true;
  return interrupt;
});
/**
