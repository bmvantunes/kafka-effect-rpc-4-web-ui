...
export const empty = () => Effect.gen(function* () {
  const ref = yield* TxRef.make(HashSet.empty());
 ...
 * @category constructors
 */
export const make = (...values) => Effect.gen(function* () {
 ...
 * @category constructors
 */
export const fromIterable = values => Effect.gen(function* () {
 ...
 * @category constructors
 */
export const fromHashSet = hashSet => Effect.gen(function* () {
  const ref = yield* TxRef.make(hashSet);
  return makeTxHashSet(ref);
});
/**
 ...
 * @category guards
 */
export const isTxHashSet = u => typeof u === "object" && u !== null && TypeId in u;
/**
 ...
 * @category mutations
 */
export const add = /*#__PURE__*/dual(2, (self, value) => TxRef.update(self.ref, set => HashSet.add(set, value)));
/**
 ...
 * @category mutations
 */
export const remove = /*#__PURE__*/dual(2, (self, value) => Effect.gen(function* () {
 ...
 * @category elements
 */
export const has = /*#__PURE__*/dual(2, (self, value) => Effect.gen(function* () {
 ...
 * @category mutations
 */
export const clear = self => TxRef.set(self.ref, HashSet.empty());
/**
 ...
 */
export const union = /*#__PURE__*/dual(2, (self, that) => Effect.gen(function* () {
 ...
 * @category combinators
 */
export const intersection = /*#__PURE__*/dual(2, (self, that) => Effect.gen(function* () {
  const set1 = yield* TxRef.get(self.ref);
  const set2 = yield* TxRef.get(that.ref);
 ...
 * @category combinators
 */
export const difference = /*#__PURE__*/dual(2, (self, that) => Effect.gen(function* () {
  const set1 = yield* TxRef.get(self.ref);
  const set2 = yield* TxRef.get(that.ref);
 ...
 * @category elements
 */
export const isSubset = /*#__PURE__*/dual(2, (self, that) => Effect.gen(function* () {
  const set1 = yield* TxRef.get(self.ref);
  const set2 = yield* TxRef.get(that.ref);
 ...
 * @category elements
 */
export const some = /*#__PURE__*/dual(2, (self, predicate) => Effect.gen(function* () {
  const set = yield* TxRef.get(self.ref);
 ...
 * @category elements
 */
export const every = /*#__PURE__*/dual(2, (self, predicate) => Effect.gen(function* () {
  const set = yield* TxRef.get(self.ref);
 ...
 * @category folding
 */
export const reduce = /*#__PURE__*/dual(3, (self, zero, f) => Effect.gen(function* () {
  const set = yield* TxRef.get(self.ref);
 ...
 */
export const toHashSet = self => TxRef.get(self.ref);
//# sourceMappingURL=TxHashSet.js.map