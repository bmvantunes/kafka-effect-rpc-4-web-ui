 ...
 * @category elements
 */
export const tail = self => self.length > 0 ? drop(self, 1) : undefined;
/**
 * Returns every elements after the first.
 *
 * @example
 ...
 * @since 2.0.0
 */
export const modify = /*#__PURE__*/dual(3, (self, i, f) => UndefinedOr.map(RA.modify(toReadonlyArray(self), i, f), fromArrayUnsafe));
/**
