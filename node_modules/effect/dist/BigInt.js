 ...
 * @since 2.0.0
 */
export const divide = /*#__PURE__*/dual(2, (self, that) => that === bigint0 ? undefined : self / that);
/**
 * Provides a division operation on `bigint`s.
 *
 * If the dividend is not a multiple of the divisor the result will be a `bigint` value
 ...
 * @since 2.0.0
 */
export const sqrt = n => isGreaterThanOrEqualTo(n, bigint0) ? sqrtUnsafe(n) : undefined;
/**
