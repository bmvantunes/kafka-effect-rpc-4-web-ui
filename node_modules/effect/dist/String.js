 ...
 * @since 2.0.0
 */
export const charCodeAt = /*#__PURE__*/dual(2, (self, index) => {
 ...
 * @since 2.0.0
 */
export const charAt = /*#__PURE__*/dual(2, (self, index) => {
 ...
 * @since 2.0.0
 */
export const codePointAt = index => self => {
 ...
 * @since 2.0.0
 */
export const indexOf = searchString => self => {
 ...
 * @since 2.0.0
 */
export const lastIndexOf = searchString => self => {
 ...
 * @since 2.0.0
 */
export const match = regExp => self => self.match(regExp);
/**
 ...
 * @since 2.0.0
 */
export const search = /*#__PURE__*/dual(2, (self, regExp) => {
