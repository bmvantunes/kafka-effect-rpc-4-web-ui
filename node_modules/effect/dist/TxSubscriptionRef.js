 ...
 */
export const changes = self => Effect.acquireRelease(Effect.transaction(Effect.gen(function* () {
 ...
 * @category subscriptions
 */
export const changesStream = self => Stream.unwrap(Effect.map(changes(self), sub => Stream.fromEffectRepeat(Effect.transaction(TxQueue.take(sub)))));
// =============================================================================
// Guards
// =============================================================================
/**
