 ...
 * @since 4.0.0
 */
export function transformOrFail(options) {
...
const passthrough_ = /*#__PURE__*/new Transformation(/*#__PURE__*/Getter.passthrough(), /*#__PURE__*/Getter.passthrough());
 ...
 * @since 4.0.0
 */
export const numberFromString = /*#__PURE__*/new Transformation(/*#__PURE__*/Getter.Number(), /*#__PURE__*/Getter.String());
/**
 ...
 * @since 4.0.0
 */
export const bigintFromString = /*#__PURE__*/new Transformation(/*#__PURE__*/Getter.BigInt(), /*#__PURE__*/Getter.String());
/**
 ...
 * @since 4.0.0
 */
export const durationFromNanos = /*#__PURE__*/transformOrFail({
  decode: i => Effect.succeed(Duration.nanos(i)),
  encode: a => {
    const nanos = Duration.toNanos(a);
    if (Predicate.isUndefined(nanos)) {
      return Effect.fail(new Issue.InvalidValue(Option.some(a), {
...
/** @internal */
export const errorFromErrorJsonEncoded = options => transform({
  decode: i => {
 ...
 * @since 4.0.0
 */
export const urlFromString = /*#__PURE__*/transformOrFail({
  decode: s => Effect.try({
    try: () => new URL(s),
    catch: e => new Issue.InvalidValue(Option.some(s), {
 ...
 * @since 4.0.0
 */
export const uint8ArrayFromBase64String = /*#__PURE__*/new Transformation(/*#__PURE__*/Getter.decodeBase64(), /*#__PURE__*/Getter.encodeBase64());
/**
 ...
 * @since 4.0.0
 */
export const fromJsonString = /*#__PURE__*/new Transformation(/*#__PURE__*/Getter.parseJson(), /*#__PURE__*/Getter.stringifyJson());
/**
 ...
 * @since 4.0.0
 */
export const fromFormData = /*#__PURE__*/new Transformation(/*#__PURE__*/Getter.decodeFormData(), /*#__PURE__*/Getter.encodeFormData());
/**
