...
export declare const findNode: {
     ...
     * @category getters
     */
    <N, E, T extends Kind = "directed">(graph: Graph<N, E, T> | MutableGraph<N, E, T>, predicate: (data: N) => boolean): NodeIndex | undefined;
};
/**
...
export declare const findEdge: {
     ...
     * @category getters
     */
    <N, E, T extends Kind = "directed">(graph: Graph<N, E, T> | MutableGraph<N, E, T>, predicate: (data: E, source: NodeIndex, target: NodeIndex) => boolean): EdgeIndex | undefined;
};
/**
...
export declare const bellmanFord: {
     ...
     * @category algorithms
     */
    <N, E, T extends Kind = "directed">(graph: Graph<N, E, T> | MutableGraph<N, E, T>, config: BellmanFordConfig<E>): PathResult<E> | undefined;
};
/**
