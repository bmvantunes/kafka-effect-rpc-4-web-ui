 ...
 * @category Caching
 */
export const asCache = /*#__PURE__*/dual(2, (self, options) => Cache.makeWith({
...
export const persisted = /*#__PURE__*/dual(2, /*#__PURE__*/Effect.fnUntraced(function* (self, options) {
  ...
  return makeWith({
    ...
    runAll: Effect.fnUntraced(function* (entries, key) {
      const results = yield* store.getMany(Iterable.map(entries, _ => _.request)).pipe(Effect.provideServices(entries[0].services));
      const leftover = [];
      ...
      yield* store.setMany(toPersist).pipe(Effect.provideServices(entries[0].services));
    })
  });
}));
