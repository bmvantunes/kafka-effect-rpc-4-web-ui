 ...
 * @category Rate Limiting
 */
export const timeout = /*#__PURE__*/dual(2, (self, duration) => transformPull(self, (pull, _scope) => Effect.succeed(Effect.timeoutOrElse(pull, {
  duration,
 ...
 * @category Merging
 */
export const merge = /*#__PURE__*/dual(2, (self, that, options) => fromChannel(Channel.merge(toChannel(self), toChannel(that), options)));
/**
 ...
 * @category Services
 */
export const provideServices = /*#__PURE__*/dual(2, (self, services) => fromChannel(Channel.provideServices(self.channel, services)));
/**
 ...
 * @category Services
 */
export const updateServices = /*#__PURE__*/dual(2, (self, f) => fromChannel(Channel.updateServices(self.channel, f)));
/**
 ...
 * @category Services
 */
export const updateService = /*#__PURE__*/dual(3, (self, service, f) => updateServices(self, services => ServiceMap.add(services, service, f(ServiceMap.get(services, service)))));
/**
 ...
 * @category Destructors
 */
export const toReadableStream = /*#__PURE__*/dual(args => isStream(args[0]), (self, options) => toReadableStreamWith(self, ServiceMap.empty(), options));
/**
 ...
 * @category Destructors
 */
export const toReadableStreamEffect = /*#__PURE__*/dual(args => isStream(args[0]), (self, options) => Effect.map(Effect.services(), context => toReadableStreamWith(self, context, options)));
/**
 ...
 * @category Destructors
 */
export const toAsyncIterableWith = /*#__PURE__*/dual(2, (self, services) => ({
 ...
 * @category Destructors
 */
export const toAsyncIterableEffect = self => Effect.map(Effect.services(), services => toAsyncIterableWith(self, services));
/**
 ...
 * @category Destructors
 */
export const toAsyncIterable = self => toAsyncIterableWith(self, ServiceMap.empty());
/**
 ...
 * @category Destructors
 */
export const toQueue = /*#__PURE__*/dual(2, (self, options) => Channel.toPubSubArray(self.channel, options));
/**
