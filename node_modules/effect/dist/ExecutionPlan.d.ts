...
export interface ExecutionPlan<Config extends {
    ...
    readonly steps: NonEmptyReadonlyArray<{
        readonly provide: ServiceMap.ServiceMap<Config["provides"]> | Layer.Layer<Config["provides"], Config["error"], Config["requirements"]>;
...
export declare const make: <const Steps extends NonEmptyReadonlyArray<make.Step>>(...steps: Steps & { [K in keyof Steps]: make.Step; }) => ExecutionPlan<{
    ...
    error: (Steps[number]["provide"] extends ServiceMap.ServiceMap<infer _P> | Layer.Layer<infer _P, infer E, infer _R> ? E : never) | (Steps[number]["while"] extends (input: infer _I) => Effect.Effect<infer _A, infer _E, infer _R_1> ? _E : never);
...
export declare namespace make {
    ...
    type StepProvides<Steps extends ReadonlyArray<any>, Out = unknown> = Steps extends readonly [infer Step, ...infer Rest] ? StepProvides<Rest, Out & ((Step extends {
        readonly provide: ServiceMap.ServiceMap<infer P> | Layer.Layer<infer P, infer _E, infer _R>;
    } ? P : unknown))> : Out;
    /**
     * @since 3.16.1
     */
 ...
 * @category Metadata
 */
export declare const CurrentMetadata: ServiceMap.Reference<Metadata>;
