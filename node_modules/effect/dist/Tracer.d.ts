...
declare const ParentSpan_base: ServiceMap.ServiceClass<ParentSpan, "effect/Tracer/ParentSpan", AnySpan>;
/**
 * @since 2.0.0
 * @category tags
 * @example
 ...
 * ```
 */
export declare const DisablePropagation: ServiceMap.Reference<boolean>;
/**
 ...
 * @since 4.0.0
 */
export declare const CurrentTraceLevel: ServiceMap.Reference<LogLevel>;
/**
 ...
 * @since 4.0.0
 */
export declare const MinimumTraceLevel: ServiceMap.Reference<LogLevel>;
/**
 * @since 4.0.0
 * @category references
 */
 ...
 * ```
 */
export declare const Tracer: ServiceMap.Reference<Tracer>;
/**
 * @since 4.0.0
