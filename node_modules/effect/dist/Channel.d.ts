...
export declare const provideServices: {
     ...
     * @category Services
     */
    <R2>(services: ServiceMap.ServiceMap<R2>): <OutElem, OutErr, OutDone, InElem, InErr, InDone, Env>(self: Channel<OutElem, OutErr, OutDone, InElem, InErr, InDone, Env>) => Channel<OutElem, OutErr, OutDone, InElem, InErr, InDone, Exclude<Env, R2>>;
    /**
     * Provides a layer or service map to the channel, removing the corresponding
     * service requirements. Use `options.local` to build the layer every time; by
     * default, layers are shared between provide calls.
     ...
     * @category Services
     */
    <OutElem, OutErr, OutDone, InElem, InErr, InDone, Env, R2>(self: Channel<OutElem, OutErr, OutDone, InElem, InErr, InDone, Env>, services: ServiceMap.ServiceMap<R2>): Channel<OutElem, OutErr, OutDone, InElem, InErr, InDone, Exclude<Env, R2>>;
};
/**
 * @since 4.0.0
 * @category Services
...
export declare const provideService: {
     ...
     * @category Services
     */
    <I, S>(key: ServiceMap.Key<I, S>, service: NoInfer<S>): <OutElem, OutErr, OutDone, InElem, InErr, InDone, Env>(self: Channel<OutElem, OutErr, OutDone, InElem, InErr, InDone, Env>) => Channel<OutElem, OutErr, OutDone, InElem, InErr, InDone, Exclude<Env, I>>;
    /**
     * @since 4.0.0
     * @category Services
     */
    <OutElem, OutErr, OutDone, InElem, InErr, InDone, Env, I, S>(self: Channel<OutElem, OutErr, OutDone, InElem, InErr, InDone, Env>, key: ServiceMap.Key<I, S>, service: NoInfer<S>): Channel<OutElem, OutErr, OutDone, InElem, InErr, InDone, Exclude<Env, I>>;
};
/**
 * @since 4.0.0
 * @category Services
...
export declare const provideServiceEffect: {
     ...
     * @category Services
     */
    <I, S, ES, RS>(key: ServiceMap.Key<I, S>, service: Effect.Effect<NoInfer<S>, ES, RS>): <OutElem, OutErr, OutDone, InElem, InErr, InDone, Env>(self: Channel<OutElem, OutErr, OutDone, InElem, InErr, InDone, Env>) => Channel<OutElem, OutErr | ES, OutDone, InElem, InErr, InDone, Exclude<Env, I> | RS>;
    /**
     * @since 4.0.0
     * @category Services
     */
    <OutElem, OutErr, OutDone, InElem, InErr, InDone, Env, I, S, ES, RS>(self: Channel<OutElem, OutErr, OutDone, InElem, InErr, InDone, Env>, key: ServiceMap.Key<I, S>, service: Effect.Effect<NoInfer<S>, ES, RS>): Channel<OutElem, OutErr | ES, OutDone, InElem, InErr, InDone, Exclude<Env, I> | RS>;
};
/**
 * @since 4.0.0
 * @category Services
...
export declare const provide: {
     ...
     * @category Services
     */
    <A, E = never, R = never>(layer: Layer.Layer<A, E, R> | ServiceMap.ServiceMap<A>, options?: {
     ...
     * @category Services
     */
    <OutElem, OutErr, OutDone, InElem, InErr, InDone, Env, A, E = never, R = never>(self: Channel<OutElem, OutErr, OutDone, InElem, InErr, InDone, Env>, layer: Layer.Layer<A, E, R> | ServiceMap.ServiceMap<A>, options?: {
        readonly local?: boolean | undefined;
...
export declare const updateServices: {
     ...
     * @category Services
     */
    <Env, R2>(f: (services: ServiceMap.ServiceMap<R2>) => ServiceMap.ServiceMap<Env>): <OutElem, OutErr, OutDone, InElem, InErr, InDone>(self: Channel<OutElem, InElem, OutErr, InErr, OutDone, InDone, Env>) => Channel<OutElem, InElem, OutErr, InErr, OutDone, InDone, R2>;
    /**
     * @since 2.0.0
     * @category Services
     */
    <OutElem, OutErr, OutDone, InElem, InErr, InDone, Env, R2>(self: Channel<OutElem, InElem, OutErr, InErr, OutDone, InDone, Env>, f: (services: ServiceMap.ServiceMap<R2>) => ServiceMap.ServiceMap<Env>): Channel<OutElem, InElem, OutErr, InErr, OutDone, InDone, R2>;
};
/**
 * @since 2.0.0
 * @category Services
...
export declare const updateService: {
     ...
     * @category Services
     */
    <I, S>(key: ServiceMap.Key<I, S>, f: (service: NoInfer<S>) => S): <OutElem, OutErr, OutDone, InElem, InErr, InDone, Env>(self: Channel<OutElem, InElem, OutErr, InErr, OutDone, InDone, Env>) => Channel<OutElem, InElem, OutErr, InErr, OutDone, InDone, Env | I>;
    /**
     * @since 2.0.0
     * @category Services
     */
    <OutElem, OutErr, OutDone, InElem, InErr, InDone, Env, I, S>(self: Channel<OutElem, InElem, OutErr, InErr, OutDone, InDone, Env>, service: ServiceMap.Key<I, S>, f: (service: NoInfer<S>) => S): Channel<OutElem, InElem, OutErr, InErr, OutDone, InDone, Env | I>;
};
/**
 * @since 4.0.0
 * @category Tracing
