 ...
 * @since 4.0.0
 */
export const mapError = /*#__PURE__*/dual(2, (self, f) => isFailure(self) ? fail(f(self.failure)) : succeed(self.success));
/**
 ...
 * @since 4.0.0
 */
export const map = /*#__PURE__*/dual(2, (self, f) => isSuccess(self) ? succeed(f(self.success)) : fail(self.failure));
/**
