...
export declare const api: import("../definitions").API<[groupId: string, generationId: number, memberId: string, groupInstanceId: NullableString, protocolType: NullableString, protocolName: NullableString, assignments: SyncGroupRequestAssignment[]], SyncGroupResponse>;