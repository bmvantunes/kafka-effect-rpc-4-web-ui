...
declare const Dispatcher_base: ServiceMap.ServiceClass<Dispatcher, "@effect/platform-node/NodeHttpClient/Dispatcher", Undici.Dispatcher>;
/**
 * @since 1.0.0
 * @category Dispatcher
 */
 ...
 * @category undici
 */
export declare const UndiciOptions: ServiceMap.Reference<Partial<Undici.Dispatcher.RequestOptions<null>>>;
/**
 * @since 1.0.0
 * @category undici
 */
...
declare const HttpAgent_base: ServiceMap.ServiceClass<HttpAgent, "@effect/platform-node/NodeHttpClient/HttpAgent", {
